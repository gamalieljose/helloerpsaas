	  ...
	  <div class="modal-content">
	    ...
	    <div class="modal-body">
	    	...
	    	<?php if($is_location_required): ?>
		    	<div class="row">
		    		<div class="col-md-12">
		    			<b><?php echo app('translator')->getFromJson('messages.location'); ?>:</b> <span class="clock_in_out_location"></span>
		    		</div>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Essentials/Providers/../Resources/views/attendance/clock_in_clock_out_modal.blade.php ENDPATH**/ ?>