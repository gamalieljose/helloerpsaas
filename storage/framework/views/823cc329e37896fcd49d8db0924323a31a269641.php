...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson( 'superadmin::lang.view_business' ); ?>
...
<section class="content">
            ...
            <div class="row">
                    <div class="col-sm-3">
                        <div class="well well-sm">
                            ...
                            <?php echo app('translator')->getFromJson('business.currency'); ?></strong>
                            <p class="text-muted">
                            ...
                            <?php echo app('translator')->getFromJson('business.tax_number1'); ?></strong>
                            <p class="text-muted">
                            ...
                            <strong><i class="fa fa-file-text-o margin-r-5"></i> 
                            <?php echo app('translator')->getFromJson('business.tax_number2'); ?></strong>
                            <p class="text-muted">
                    ...
                    <div class="col-sm-3">
                        <div class="well well-sm">
                            ...
                            <?php echo app('translator')->getFromJson('business.time_zone'); ?></strong>
                            <p class="text-muted">
                            ...
                            <?php echo app('translator')->getFromJson('business.is_active'); ?></strong>
                            ...
                            <?php echo app('translator')->getFromJson('business.created_by'); ?></strong>
                    ...
                    <div class="col-sm-3">
                        <div class="well well-sm">
                            <strong><i class="fa fa-user-circle-o margin-r-5"></i> 
                            <?php echo app('translator')->getFromJson('business.owner'); ?></strong>
                            ...
                            <?php echo app('translator')->getFromJson('business.email'); ?></strong>
                            <p class="text-muted">
                            ...
                            <?php echo app('translator')->getFromJson('business.mobile'); ?></strong>
                            <p class="text-muted">
                            ...
                            <?php echo app('translator')->getFromJson('business.address'); ?></strong>
                            <p class="text-muted">
    ...
    <div class="box">
        <div class="box-header">
                <h3 class="box-title">
                    <strong><i class="fa fa-map-marker margin-r-5"></i> 
                    <?php echo app('translator')->getFromJson( 'superadmin::lang.business_location' ); ?></strong>
                </h3>
        </div>
        <div class="box-body">
                <div class="row">
    ...
    <div class="box">
        <div class="box-header">
                <h3 class="box-title">
                    ...
                    <?php echo app('translator')->getFromJson( 'superadmin::lang.package_subscription' ); ?></strong>
                </h3>
        </div>
        <div class="box-body">
                <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Superadmin/Providers/../Resources/views/business/show.blade.php ENDPATH**/ ?>