                ...
                <?php if($key == 'new_sale'): ?>
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <label class="checkbox-inline">
                                <?php echo Form::checkbox('template_data[' . $key . '][auto_send_wa_notif]', 1, $value['auto_send_wa_notif'], ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.auto_send_wa_notif'); ?>
                            </label>
                        </div>
                    </div>
                <?php endif; ?>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/notification_template/partials/tabs.blade.php ENDPATH**/ ?>