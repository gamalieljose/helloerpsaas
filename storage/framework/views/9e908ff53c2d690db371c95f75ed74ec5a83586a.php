...
<?php echo Form::hidden('location_id', $sell->location->id, ['id' => 'location_id', 'data-receipt_printer_type' => $sell->location->receipt_printer_type ]);; ?>
	...
	<div class="box box-solid">
		<div class="box-header">
			<h3 class="box-title"><?php echo app('translator')->getFromJson('lang_v1.parent_sale'); ?></h3>
		</div>
		<div class="box-body">
			<div class="row">
				<div class="col-sm-4">
		...
		<div class="box-body">
					...
					<table class="table bg-gray" id="sell_return_table">
			          	<thead>
				            <tr class="bg-green">
				              	...
				              	<th><?php echo app('translator')->getFromJson('lang_v1.sell_quantity'); ?></th>
				            ...
				            <tr>
				              	...
				              	<td>
						            ...
						            data-msg-abs_digit="<?php echo app('translator')->getFromJson('lang_v1.decimal_value_not_allowed'); ?>"
			              			...
			              			data-msg-max-value="<?php echo app('translator')->getFromJson('validation.custom-messages.quantity_not_available', ['qty' => $sell_line->formatted_qty, 'unit' => $unit_name ]); ?>" 
						            >
			...
			<div class="row">
				<div class="col-sm-12 text-right">
					<strong><?php echo app('translator')->getFromJson('lang_v1.total_return_discount'); ?>:</strong> 
					&nbsp;(-) <span id="total_return_discount"></span>
				</div>
				<div class="col-sm-12 text-right">
					<strong><?php echo app('translator')->getFromJson('lang_v1.total_return_tax'); ?> - <?php if(!empty($sell->tax)): ?>(<?php echo e($sell->tax->name, false); ?> - <?php echo e($sell->tax->amount, false); ?>%)<?php endif; ?> : </strong> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/sell_return/add.blade.php ENDPATH**/ ?>