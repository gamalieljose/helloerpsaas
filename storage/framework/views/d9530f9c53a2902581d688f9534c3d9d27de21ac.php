...
<section class="content-header">
	<h3>
		...
		<?php echo app('translator')->getFromJson('project::lang.tasks'); ?>
	</h3>
</section>
		    ...
		    <table class="table table-bordered table-striped" id="my_task_table">
		        <thead>
		            <tr>
		            	...
		            	<th class="col-md-2">
		            		<?php echo app('translator')->getFromJson('project::lang.project'); ?>
		            	</th>
		                <th class="col-md-3">
		                	<?php echo app('translator')->getFromJson('project::lang.subject'); ?>
		                </th>
		                <th class="col-md-2">
		                	<?php echo app('translator')->getFromJson('project::lang.assigned_to'); ?>
		                </th>
		                <th> <?php echo app('translator')->getFromJson('project::lang.priority'); ?></th>
		                <th> <?php echo app('translator')->getFromJson('business.start_date'); ?></th>
		                <th><?php echo app('translator')->getFromJson('project::lang.due_date'); ?></th>
		                <th><?php echo app('translator')->getFromJson('sale.status'); ?></th>
		                <th> <?php echo app('translator')->getFromJson('project::lang.assigned_by'); ?></th>
		                <th><?php echo app('translator')->getFromJson('project::lang.task_custom_field_1'); ?></th>
		                <th><?php echo app('translator')->getFromJson('project::lang.task_custom_field_2'); ?></th>
		                <th><?php echo app('translator')->getFromJson('project::lang.task_custom_field_3'); ?></th>
		                <th><?php echo app('translator')->getFromJson('project::lang.task_custom_field_4'); ?></th>
		            </tr>
		        </thead>
		    </table>
		</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Project/Providers/../Resources/views/my_task/index.blade.php ENDPATH**/ ?>