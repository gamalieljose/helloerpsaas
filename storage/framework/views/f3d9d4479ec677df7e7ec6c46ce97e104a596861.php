...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('barcode.edit_barcode_setting'); ?></h1>
</section>
      ...
      <div class="row">
        ...
        <div class="col-sm-12">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('is_continuous', 1, $barcode->is_continuous, ['id' => 'is_continuous']);; ?> <?php echo app('translator')->getFromJson('barcode.is_continuous'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/barcode/edit.blade.php ENDPATH**/ ?>