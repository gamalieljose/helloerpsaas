<?php $__env->startSection('title', __('restaurant.bookings')); ?>

<?php $__env->startSection('content'); ?>

<!-- Content Header (Page header) -->
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson( 'restaurant.bookings' ); ?></h1>
    <!-- <ol class="breadcrumb">
        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><?php echo app('translator')->getFromJson('restaurant.todays_bookings'); ?></h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table class="table table-bordered table-condensed" id="todays_bookings_table">
                        ...
                        <tr>
                            ...
                            <th><?php echo app('translator')->getFromJson('restaurant.booking_starts'); ?></th>
                            <th><?php echo app('translator')->getFromJson('restaurant.booking_ends'); ?></th>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-sm-12 text-right">
                            <button type="button" class="btn btn-primary" id="add_new_booking_btn"><i class="fa fa-plus"></i> <?php echo app('translator')->getFromJson('restaurant.add_booking'); ?></button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
        ...
        <div class="col-sm-2">
            <div class="box box-solid">
                <div class="box-body">
                    ...
                    <small>
                    <p class="help-block">
                        <i><?php echo app('translator')->getFromJson('restaurant.click_on_any_booking_to_view_or_change_status'); ?><br><br>
                        <?php echo app('translator')->getFromJson('restaurant.double_click_on_any_day_to_add_new_booking'); ?>
                        </i>
                    </p>
                    </small>
                </div>
...
<?php echo $__env->make('restaurant.booking.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</section>
<!-- /.content -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/restaurant/booking/index.blade.php ENDPATH**/ ?>