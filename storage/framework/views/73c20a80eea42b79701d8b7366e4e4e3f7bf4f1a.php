...
<div class="row">
	<div class="col-md-12">
		...
		<div class="col-md-4">
			...
			<p><strong><?php echo app('translator')->getFromJson( 'lang_v1.gender' ); ?>:</strong> <?php if(!empty($user->gender)): ?> <?php echo app('translator')->getFromJson('lang_v1.' .$user->gender); ?> <?php endif; ?></p>
			...
			<p><strong><?php echo app('translator')->getFromJson( 'lang_v1.mobile_number' ); ?>:</strong> <?php echo e($user->contact_number ?? '', false); ?></p>
			<p><strong><?php echo app('translator')->getFromJson( 'business.alternate_number' ); ?>:</strong> <?php echo e($user->alt_number ?? '', false); ?></p>
			<p><strong><?php echo app('translator')->getFromJson( 'lang_v1.family_contact_number' ); ?>:</strong> <?php echo e($user->family_number ?? '', false); ?></p>
		</div>
		<div class="col-md-4">
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/user/show_details.blade.php ENDPATH**/ ?>