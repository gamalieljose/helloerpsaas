<div class="modal-dialog modal-lg" role="document">
  ...
  ?>
    ...
    <div class="modal-body">
        <div class="row">            
            ...
            <div class="col-md-4 mt-15">
                <label class="radio-inline">
                    ...
                    <?php echo app('translator')->getFromJson('lang_v1.individual'); ?>
                </label>
                <label class="radio-inline">
        ...
        <div class="row">
            <div class="col-md-12">
                <button type="button" class="btn btn-primary center-block more_btn" data-target="#more_div"><?php echo app('translator')->getFromJson('lang_v1.more_info'); ?> <i class="fa fa-chevron-down"></i></button>
            </div>
            ...
            <?php if(!empty($common_settings['is_enabled_export'])): ?>
                <div class="col-md-12 mb-12">
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="is_customer_export"><?php echo app('translator')->getFromJson('lang_v1.is_export'); ?></label>
                    </div>
                </div>
                <?php
                    $i = 1;
...
</div><!-- /.modal-dialog --><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/contact/create.blade.php ENDPATH**/ ?>