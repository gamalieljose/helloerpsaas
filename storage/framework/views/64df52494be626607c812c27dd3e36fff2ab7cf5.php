  ...
  <div class="row">
    <div class="col-md-6">
      <div class="m-6 mt-5" style="display: flex;">
        <p ><strong><?php echo app('translator')->getFromJson('sale.location'); ?>: &nbsp;</strong> 
      ...
      <?php endif; ?>
        ...
        <button type="button" title="<?php echo e(__('expense.add_expense'), false); ?>"   
          data-placement="bottom" class="btn bg-purple btn-flat m-6 btn-xs m-5 btn-modal pull-right" id="add_expense">
            <strong><i class="fa fas fa-minus-circle"></i> <?php echo app('translator')->getFromJson('expense.add_expense'); ?></strong>
        </button>
        <?php endif; ?>
...
<?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/layouts/partials/header-pos.blade.php ENDPATH**/ ?>