<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo app('translator')->getFromJson( 'lang_v1.add_type_of_service' ); ?></h4>
    </div>
    ...
    <div class="modal-body">
      ...
      <div class="form-group col-md-12">
          <div class="checkbox">
            <label>
               <?php echo Form::checkbox('enable_custom_fields', 1, false);; ?> <?php echo app('translator')->getFromJson( 'lang_v1.enable_custom_fields' ); ?>
            </label> <?php
...
</div><!-- /.modal-dialog --><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/types_of_service/create.blade.php ENDPATH**/ ?>