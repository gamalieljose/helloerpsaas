...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson( 'superadmin::lang.all_business' ); ?>
        <small><?php echo app('translator')->getFromJson( 'superadmin::lang.manage_business' ); ?></small>
    </h1>
    <!-- <ol class="breadcrumb">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="superadmin_business_table">
                        <thead>
                            <tr>
                                <th>
                                    <?php echo app('translator')->getFromJson('superadmin::lang.registered_on'); ?>
                                </th>
                                <th><?php echo app('translator')->getFromJson( 'superadmin::lang.business_name' ); ?></th>
                                <th><?php echo app('translator')->getFromJson('business.owner'); ?></th>
                                <th><?php echo app('translator')->getFromJson('business.email'); ?></th>
                                <th><?php echo app('translator')->getFromJson('superadmin::lang.owner_number'); ?></th>
                                <th><?php echo app('translator')->getFromJson( 'superadmin::lang.business_contact_number' ); ?></th>
                                <th><?php echo app('translator')->getFromJson('business.address'); ?></th>
                                <th><?php echo app('translator')->getFromJson( 'sale.status' ); ?></th>
                                <th><?php echo app('translator')->getFromJson( 'superadmin::lang.current_subscription' ); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Superadmin/Providers/../Resources/views/business/index.blade.php ENDPATH**/ ?>