    ...
    <div class="col-sm-4">
        <div class="form-group">
            <?php echo Form::label('search_product', __('repair::lang.search_default_product') . ':'); ?> <?php
                ...
                <p class="help-block">
                    <strong><?php echo app('translator')->getFromJson('repair::lang.selected_default_product'); ?>:</strong>
...
<div class="row">
    <div class="col-md-3">
        <div class="form-group">
            <?php echo Form::label('job_sheet_custom_field_1', __('repair::lang.label_for_job_sheet_custom_field', ['number' => 1]) . ':'); ?>

            <?php echo Form::text('job_sheet_custom_field_1',!empty($repair_settings['job_sheet_custom_field_1'])? $repair_settings['job_sheet_custom_field_1'] : '', ['class' => 'form-control ', 'id' => 'job_sheet_custom_field_1']);; ?>

        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            <?php echo Form::label('job_sheet_custom_field_2', __('repair::lang.label_for_job_sheet_custom_field', ['number' => 2]) . ':'); ?>

            <?php echo Form::text('job_sheet_custom_field_2',!empty($repair_settings['job_sheet_custom_field_1'])? $repair_settings['job_sheet_custom_field_2'] : '', ['class' => 'form-control ', 'id' => 'job_sheet_custom_field_2']);; ?>

        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            <?php echo Form::label('job_sheet_custom_field_3', __('repair::lang.label_for_job_sheet_custom_field', ['number' => 3]) . ':'); ?>

            <?php echo Form::text('job_sheet_custom_field_3',!empty($repair_settings['job_sheet_custom_field_3'])? $repair_settings['job_sheet_custom_field_3'] : '', ['class' => 'form-control ', 'id' => 'job_sheet_custom_field_3']);; ?>

        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            <?php echo Form::label('job_sheet_custom_field_4', __('repair::lang.label_for_job_sheet_custom_field', ['number' => 4]) . ':'); ?>

            <?php echo Form::text('job_sheet_custom_field_4',!empty($repair_settings['job_sheet_custom_field_1'])? $repair_settings['job_sheet_custom_field_4'] : '', ['class' => 'form-control ', 'id' => 'job_sheet_custom_field_4']);; ?>

        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            <?php echo Form::label('job_sheet_custom_field_5', __('repair::lang.label_for_job_sheet_custom_field', ['number' => 5]) . ':'); ?>

            <?php echo Form::text('job_sheet_custom_field_5',!empty($repair_settings['job_sheet_custom_field_5'])? $repair_settings['job_sheet_custom_field_5'] : '', ['class' => 'form-control ', 'id' => 'job_sheet_custom_field_5']);; ?>
...
<?php echo Form::close(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Repair/Providers/../Resources/views/settings/partials/repair_settings_tab.blade.php ENDPATH**/ ?>