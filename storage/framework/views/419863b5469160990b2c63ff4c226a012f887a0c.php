	...
	<div class="modal-dialog" role="document">
	  <div class="modal-content">
	    ...
	    <div class="modal-header">
	      	...
	      	<h4 class="modal-title"><?php echo app('translator')->getFromJson( 'essentials::lang.change_status' ); ?></h4>
	    </div>

	    <div class="modal-body">
	      	<div class="form-group">
	      		<input type="hidden" name="leave_id" id="leave_id">
	      		<label for="status"><?php echo app('translator')->getFromJson( 'sale.status' ); ?>:*</label>
	      	...
	      	<div class="form-group">
	      		<label for="status_note"><?php echo app('translator')->getFromJson( 'brand.note' ); ?>:</label>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Essentials/Providers/../Resources/views/leave/change_status_modal.blade.php ENDPATH**/ ?>