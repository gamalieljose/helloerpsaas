<div class="pos-tab-content">
    ...
    <div class="row">
        <div class="col-md-12"><h4><?php echo app('translator')->getFromJson('lang_v1.payment_link'); ?> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/business/partials/settings_sales.blade.php ENDPATH**/ ?>