        ...
        <div class="col-sm-4">
            <div class="form-group">
                <?php echo Form::label('business_logo', __('business.upload_logo') . ':'); ?>
                    ...
                    <p class="help-block"><i> <?php echo app('translator')->getFromJson('business.logo_help'); ?></i></p>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/business/partials/settings_business.blade.php ENDPATH**/ ?>