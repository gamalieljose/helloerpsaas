...
<section class="content">
    <?php $__env->startComponent('components.filters', ['title' => __('report.filters'), 'class' => 'hide']); ?>
    <?php if($type == 'customer'): ?>
        <div class="col-md-3">
            <div class="form-group">
                <label>
                    <?php echo Form::checkbox('has_sell_due', 1, false, ['class' => 'input-icheck', 'id' => 'has_sell_due']);; ?> <strong><?php echo app('translator')->getFromJson('lang_v1.sell_due'); ?></strong>
                </label>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                <label>
                    <?php echo Form::checkbox('has_sell_return', 1, false, ['class' => 'input-icheck', 'id' => 'has_sell_return']);; ?> <strong><?php echo app('translator')->getFromJson('lang_v1.sell_return'); ?></strong>
                </label>
            </div>
        </div>
    <?php elseif($type == 'supplier'): ?>
        <div class="col-md-3">
            <div class="form-group">
                <label>
                    <?php echo Form::checkbox('has_purchase_due', 1, false, ['class' => 'input-icheck', 'id' => 'has_purchase_due']);; ?> <strong><?php echo app('translator')->getFromJson('report.purchase_due'); ?></strong>
                </label>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                <label>
                    <?php echo Form::checkbox('has_purchase_return', 1, false, ['class' => 'input-icheck', 'id' => 'has_purchase_return']);; ?> <strong><?php echo app('translator')->getFromJson('lang_v1.purchase_return'); ?></strong>
                </label>
            </div>
        </div>
    <?php endif; ?>
    <div class="col-md-3">
        <div class="form-group">
            <label>
                <?php echo Form::checkbox('has_advance_balance', 1, false, ['class' => 'input-icheck', 'id' => 'has_advance_balance']);; ?> <strong><?php echo app('translator')->getFromJson('lang_v1.advance_balance'); ?></strong>
            </label>
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
            <label>
                <?php echo Form::checkbox('has_opening_balance', 1, false, ['class' => 'input-icheck', 'id' => 'has_opening_balance']);; ?> <strong><?php echo app('translator')->getFromJson('lang_v1.opening_balance'); ?></strong>
            </label>
        </div>
    </div>
                ...
                <thead>
                    <tr>
                        ...
                        <?php if($type == 'supplier'): ?> 
                            ...
                            <th><?php echo app('translator')->getFromJson('contact.tax_no'); ?></th>
                            <th><?php echo app('translator')->getFromJson('contact.pay_term'); ?></th>
                            <th><?php echo app('translator')->getFromJson('account.opening_balance'); ?></th>
                            <th><?php echo app('translator')->getFromJson('lang_v1.advance_balance'); ?></th>
                        ...
                        <?php elseif( $type == 'customer'): ?>
                            ...
                            <th><?php echo app('translator')->getFromJson('business.email'); ?></th>
                            <th><?php echo app('translator')->getFromJson('contact.tax_no'); ?></th>
                            <th><?php echo app('translator')->getFromJson('lang_v1.credit_limit'); ?></th>
                            <th><?php echo app('translator')->getFromJson('contact.pay_term'); ?></th>
                            <th><?php echo app('translator')->getFromJson('account.opening_balance'); ?></th>
                            <th><?php echo app('translator')->getFromJson('lang_v1.advance_balance'); ?></th>
                            <th><?php echo app('translator')->getFromJson('lang_v1.added_on'); ?></th>
                            ...
                            <th><?php echo app('translator')->getFromJson('business.address'); ?></th>
                            <th><?php echo app('translator')->getFromJson('contact.mobile'); ?></th>
                            <th><?php echo app('translator')->getFromJson('contact.total_sale_due'); ?></th>
                            <th><?php echo app('translator')->getFromJson('lang_v1.total_sell_return_due'); ?></th>
                        <?php endif; ?>
                        <?php
                ...
                <tfoot>
                    <tr class="bg-gray font-17 text-center footer-total">
                        ...
                        <td
                            ...
                            <?php endif; ?>>
                                <strong>
                                    <?php echo app('translator')->getFromJson('sale.total'); ?>:
                                </strong>
                        </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/contact/index.blade.php ENDPATH**/ ?>