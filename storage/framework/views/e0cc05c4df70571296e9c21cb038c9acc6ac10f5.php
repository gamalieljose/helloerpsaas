<tr data-user_id="<?php echo e($user->id, false); ?>">
	...
	<td>
		...
		<?php else: ?>
			<?php echo e(\Carbon::createFromTimestamp(strtotime($attendance->clock_in_time))->format(session('business.date_format') . ' ' . 'h:i A'), false); ?> <br>
			<small class="text-muted">(<?php echo app('translator')->getFromJson('essentials::lang.clocked_in'); ?> - <?php echo e(\Carbon::parse($attendance->clock_in_time)->diffForHumans(\Carbon::now()), false); ?>)</small>
...
</tr><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Essentials/Providers/../Resources/views/attendance/attendance_row.blade.php ENDPATH**/ ?>