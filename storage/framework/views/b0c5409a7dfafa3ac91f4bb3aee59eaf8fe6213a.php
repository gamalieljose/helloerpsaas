...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('essentials::lang.leave'); ?>
    </h1>
</section>
<!-- Main content -->
<section class="content">
    <div class="row">
        ...
        <?php $__env->startComponent('components.filters', ['title' => __('report.filters'), 'class' => 'box-solid']); ?>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="status_filter"><?php echo app('translator')->getFromJson( 'sale.status' ); ?>:</label>
                    <select class="form-control select2" name="status_filter" required id="status_filter" style="width: 100%;">
                        <option value=""><?php echo app('translator')->getFromJson('lang_v1.all'); ?></option>
                    ...
                    <table class="table table-bordered table-striped" id="leave_table">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo app('translator')->getFromJson( 'essentials::lang.leave_type' ); ?></th>
                                <th><?php echo app('translator')->getFromJson('essentials::lang.employee'); ?></th>
                                <th><?php echo app('translator')->getFromJson( 'lang_v1.date' ); ?></th>
                                <th><?php echo app('translator')->getFromJson( 'essentials::lang.reason' ); ?></th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Essentials/Providers/../Resources/views/leave/index.blade.php ENDPATH**/ ?>