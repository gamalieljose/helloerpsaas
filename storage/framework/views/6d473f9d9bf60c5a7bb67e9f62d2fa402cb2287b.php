			...
			<div class="col-md-3">
				<div class="box box-solid box-warning">
					<div class="box-header with-border">
						<h4 class="box-title">
							<?php echo app('translator')->getFromJson('project::lang.incompleted_tasks'); ?>
						</h4>
						<!-- /.box-tools -->
					</div>
					<!-- /.box-header -->
			...
			<?php if(isset($project->settings['enable_timelog']) && $project->settings['enable_timelog']): ?>
				<div class="col-md-3">
					<div class="box box-solid box-info">
						<div class="box-header with-border">
							<h4 class="box-title">
								<?php echo app('translator')->getFromJson('project::lang.total_time'); ?>
							</h4>
							<!-- /.box-tools -->
						</div>
						<!-- /.box-header -->
			...
			<?php if((isset($project->settings['enable_invoice']) && $project->settings['enable_invoice']) && $is_lead_or_admin): ?>
				<div class="col-md-3">
					<div class="box box-solid box-success">
						<div class="box-header with-border">
							<h4 class="box-title">
								<?php echo app('translator')->getFromJson('sale.total_paid'); ?>
			...
			<?php if((isset($project->settings['enable_invoice']) && $project->settings['enable_invoice']) && $is_lead_or_admin): ?>
				<div class="col-md-3">
					<div class="box box-solid box-danger">
						<div class="box-header with-border">
							<h4 class="box-title">
								<?php echo app('translator')->getFromJson('sale.total_remaining'); ?>
								<small class="text-white">
									<?php echo app('translator')->getFromJson('project::lang.invoice'); ?>
								</small>
							</h4>
		...
		<div class="box box-solid box-default">
			...
			<div class="box-body">
				...
				<?php if(isset($project->customer->mobile)): ?>
					...
					<?php echo app('translator')->getFromJson('contact.mobile'); ?>: <?php echo e($project->customer->mobile, false); ?>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Project/Providers/../Resources/views/project/partials/overview.blade.php ENDPATH**/ ?>