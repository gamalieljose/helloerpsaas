			...
			<table class="table table-condensed table-bordered table-striped table-responsive add-product-price-table combo_product_table">
				<thead>
					<tr>
						...
						<th class="text-center">
							<?php echo app('translator')->getFromJson('lang_v1.purchase_price_exc_tax'); ?>
						</th>
						<th class="text-center">
				...
				<tfoot class="combo_product_table_footer">
					<tr>
						...
						<td class="text-center"> 
							<b> <?php echo app('translator')->getFromJson( 'purchase.net_total_amount' ); ?></b> :
						</td>
						<td>
						</td>
						<td class="text-center">
...
</script><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/product/partials/combo_product_form_part.blade.php ENDPATH**/ ?>