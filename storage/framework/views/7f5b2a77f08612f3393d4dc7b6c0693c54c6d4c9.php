...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('essentials::lang.leave_type'); ?>
    </h1>
</section>
<!-- Main content -->
            ...
            <table class="table table-bordered table-striped" id="leave_type_table">
                <thead>
                    <tr>
                        ...
                        <th><?php echo app('translator')->getFromJson( 'essentials::lang.max_leave_count' ); ?></th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Essentials/Providers/../Resources/views/leave_type/index.blade.php ENDPATH**/ ?>