...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('superadmin::lang.super_admin_settings'); ?><small><?php echo app('translator')->getFromJson('superadmin::lang.edit_super_admin_settings'); ?></small></h1>
    <!-- <ol class="breadcrumb">
            ...
            <div class="col-xs-12 pos-tab-container">
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                    <div class="list-group">
                        <a href="#" class="list-group-item text-center active"><?php echo app('translator')->getFromJson('superadmin::lang.super_admin_settings'); ?></a>
                        <a href="#" class="list-group-item text-center"><?php echo app('translator')->getFromJson('superadmin::lang.application_settings'); ?></a>
                        <a href="#" class="list-group-item text-center"><?php echo app('translator')->getFromJson('superadmin::lang.email_smtp_settings'); ?></a>
                        <a href="#" class="list-group-item text-center"><?php echo app('translator')->getFromJson('superadmin::lang.payment_gateways'); ?></a>
                        <a href="#" class="list-group-item text-center"><?php echo app('translator')->getFromJson('superadmin::lang.backup'); ?></a>
                        <a href="#" class="list-group-item text-center"><?php echo app('translator')->getFromJson('superadmin::lang.cron'); ?></a>
                        <a href="#" class="list-group-item text-center"><?php echo app('translator')->getFromJson('superadmin::lang.pusher_settings'); ?></a>
                        <a href="#" class="list-group-item text-center"><?php echo app('translator')->getFromJson('superadmin::lang.additional_js_css'); ?></a>
                    </div>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Superadmin/Providers/../Resources/views/superadmin_settings/edit.blade.php ENDPATH**/ ?>