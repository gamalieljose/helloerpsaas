	...
	<table class="table table-striped <?php if(!empty($for_pdf)): ?> table-pdf td-border <?php endif; ?>" id="ledger_table">
		<thead>
			<tr class="row-border blue-heading">
				...
				<th width="10%" class="text-center"><?php echo app('translator')->getFromJson('lang_v1.balance'); ?></th>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/contact/ledger.blade.php ENDPATH**/ ?>