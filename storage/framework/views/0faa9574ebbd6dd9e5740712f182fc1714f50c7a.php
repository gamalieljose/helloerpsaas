	...
	<div class="modal-dialog" role="document">
		...
		<?php echo Form::open(['url' => action('Restaurant\BookingController@store'), 'method' => 'post', 'id' => 'add_booking_form' ]); ?>
			...
			<div class="modal-header">
				...
				<h4 class="modal-title"><?php echo app('translator')->getFromJson( 'restaurant.add_booking' ); ?></h4>
				</div>
				...
				<div class="modal-body">
					...
					<div class="col-sm-12">
						<div class="form-group">
						<div class="checkbox">
							<?php echo Form::checkbox('send_notification', 1, true, ['class' => 'input-icheck', 'id' => 'send_notification']);; ?> <?php echo app('translator')->getFromJson('restaurant.send_notification_to_customer'); ?>
						</div>
					</div>
				</div>
				</div>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/restaurant/booking/create.blade.php ENDPATH**/ ?>