...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson( 'lang_v1.types_of_service' ); ?> <?php
                ...
                <table class="table table-bordered table-striped" id="types_of_service_table">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo app('translator')->getFromJson( 'lang_v1.packing_charge' ); ?></th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/types_of_service/index.blade.php ENDPATH**/ ?>