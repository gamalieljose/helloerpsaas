      		...
      		<div class="row">
      			...
      			<div class="col-md-8">
      				<?php if($product->type == 'single' || $product->type == 'combo'): ?>
      					<div class="col-md-12">
      						<p class="lead"><?php echo app('translator')->getFromJson('lang_v1.price'); ?>: &nbsp;&nbsp;&nbsp;<span class="display_currency" data-currency_symbol="true"><?php echo e($product->variations->first()->sell_price_inc_tax, false); ?></span></p><br>
      					</div>
      				<?php endif; ?>
      				<div class="col-md-12">
...
<?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/ProductCatalogue/Providers/../Resources/views/catalogue/show.blade.php ENDPATH**/ ?>