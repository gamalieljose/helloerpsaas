	...
	<div class="modal-dialog" role="document">
	  <div class="modal-content">
	    ...
	    <div class="modal-header">
	      ...
	      <h4 class="modal-title"><?php echo app('translator')->getFromJson( 'essentials::lang.add_leave_type' ); ?></h4>
	    </div>
	    ...
	    <div class="modal-body">
	      	...
	      	<div class="form-group">
	      		<strong><?php echo app('translator')->getFromJson('essentials::lang.leave_count_interval'); ?></strong><br>
	      		<label class="radio-inline">
	      			<?php echo Form::radio('leave_count_interval', 'month', false);; ?> <?php echo app('translator')->getFromJson('essentials::lang.current_month'); ?>
	      		</label>
	      		<label class="radio-inline">
	      			<?php echo Form::radio('leave_count_interval', 'year', false);; ?> <?php echo app('translator')->getFromJson('essentials::lang.current_fy'); ?>
	      		</label>
	      		<label class="radio-inline">
	      			<?php echo Form::radio('leave_count_interval', null, false);; ?> <?php echo app('translator')->getFromJson('lang_v1.none'); ?>
	      		</label>
	      	</div>
	    </div>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Essentials/Providers/../Resources/views/leave_type/create.blade.php ENDPATH**/ ?>