...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson( 'account.trial_balance'); ?>
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box box-solid">
        <div class="box-header print_section">
            <h3 class="box-title"><?php echo e(session()->get('business.name'), false); ?> - <?php echo app('translator')->getFromJson( 'account.trial_balance'); ?> - <span id="hidden_date"><?php echo e(\Carbon::createFromTimestamp(strtotime('now'))->format(session('business.date_format')), false); ?></span></h3>
        </div>
        <div class="box-body">
            <table class="table table-border-center-col no-border table-pl-12" id="trial_balance_table">
                <thead>
                    <tr class="bg-gray">
                        <th><?php echo app('translator')->getFromJson('account.trial_balance'); ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        <th><?php echo app('translator')->getFromJson('account.account_balances'); ?>:</th>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
                </tbody>
...
<script type="text/javascript">
    ...
    function update_trial_balance(){
        ...
        $.ajax({
            url: "<?php echo e(action('AccountReportsController@trialBalance'), false); ?>?end_date=" + end_date + '&location_id=' + location_id,
            dataType: "json",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/account_reports/trial_balance.blade.php ENDPATH**/ ?>