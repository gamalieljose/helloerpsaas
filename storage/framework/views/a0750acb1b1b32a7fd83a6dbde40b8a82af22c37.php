      ...
      <?php if(!empty($register_details->denominations)): ?>
        ...
        <div class="row">
          <div class="col-md-8 col-sm-12">
            ...
            $formated_number .= number_format((float) $key * $value, config("constants.currency_precision", 2) , session("currency")["decimal_separator"], session("currency")["thousand_separator"]);
            ...
            $formated_number .= number_format((float) $total, config("constants.currency_precision", 2) , session("currency")["decimal_separator"], session("currency")["thousand_separator"]);
...
</style><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/cash_register/register_details.blade.php ENDPATH**/ ?>