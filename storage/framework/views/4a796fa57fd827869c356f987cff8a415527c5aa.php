...
<div class="row well">
    ...
    <div class="col-sm-12">
        <h4><?php echo app('translator')->getFromJson('lang_v1.earning_points_setting'); ?>:</h4>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
   ...
   <div class="row well">
    <div class="col-sm-12">
        <h4><?php echo app('translator')->getFromJson('lang_v1.redeem_points_setting'); ?>:</h4>
    </div>
    <div class="col-sm-4">
        <div class="form-group">
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/business/partials/settings_reward_point.blade.php ENDPATH**/ ?>