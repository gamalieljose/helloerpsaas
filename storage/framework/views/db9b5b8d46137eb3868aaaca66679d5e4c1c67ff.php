<?php echo Form::open(['url' => action('\Modules\Project\Http\Controllers\ProjectController@postSettings', ['project_id' => $project->id]), 'id' => 'settings_form', 'method' => 'put']); ?>
	...
	<div class="row">
		<div class="col-md-4">
			<div class="checkbox">
				<label>
				  ...
				  && $project->settings['enable_timelog']): ?> checked <?php endif; ?>> <?php echo app('translator')->getFromJson('project::lang.enable_timelog'); ?>
				</label>
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="checkbox">
				<label>
				  <input type="checkbox" name="enable_notes_documents" value="1" <?php if(isset($project->settings['enable_notes_documents']) && $project->settings['enable_notes_documents']): ?> checked <?php endif; ?>> <?php echo app('translator')->getFromJson('project::lang.enable_notes_documents'); ?>
				</label>
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="checkbox">
				<label>
				  <input type="checkbox" name="enable_invoice" value="1" <?php if(isset($project->settings['enable_invoice']) && $project->settings['enable_invoice']): ?> checked <?php endif; ?>> <?php echo app('translator')->getFromJson('project::lang.enable_invoice'); ?>
				</label>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-4">
			<label><?php echo app('translator')->getFromJson('project::lang.task_view'); ?>:&nbsp;</label>
			<label class="radio-inline">
				...
				<?php echo app('translator')->getFromJson('project::lang.list_view'); ?>
			</label>
			<label class="radio-inline">
				...
				<?php echo app('translator')->getFromJson('project::lang.kanban_board'); ?>
			</label>
		</div>
		<div class="col-md-4">
			<?php
	...
	<div class="row">
		...
		<div class="col-md-3">
			<label><?php echo app('translator')->getFromJson('project::lang.members'); ?></label>
		</div>
	</div>
	<div class="row">
		<div class="col-md-3">
			<label for="members_crud_task">
				<?php echo app('translator')->getFromJson('project::lang.add_a_task'); ?>
			</label>
		</div>
		<div class="col-md-3">
	...
	<div class="row">
		<div class="col-md-3">
			<label for="members_crud_note">
				<?php echo app('translator')->getFromJson('project::lang.add_notes_docs'); ?>
			</label>
		</div>
		<div class="col-md-3">
...
<?php echo Form::close(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Project/Providers/../Resources/views/settings/create.blade.php ENDPATH**/ ?>