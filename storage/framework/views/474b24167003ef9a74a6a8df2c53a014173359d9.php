...
<div class="table-responsive">
    ...
    id="purchase_entry_table">
        <thead>
              <tr>
                ...
                <th><?php if(empty($is_purchase_order)): ?> <?php echo app('translator')->getFromJson( 'purchase.purchase_quantity' ); ?> <?php else: ?> <?php echo app('translator')->getFromJson( 'lang_v1.order_quantity' ); ?> <?php endif; ?></th>
                ...
                <?php if(empty($is_purchase_order)): ?>
                    <th><?php echo app('translator')->getFromJson( 'purchase.unit_selling_price'); ?> <small>(<?php echo app('translator')->getFromJson('product.inc_of_tax'); ?>)</small></th>
                    ...
                    <?php if(session('business.enable_product_expiry')): ?>
                        <th><?php echo app('translator')->getFromJson('product.mfg_date'); ?> / <?php echo app('translator')->getFromJson('product.exp_date'); ?></th>
                    <?php endif; ?>
                <?php endif; ?>
                <th>
    ...
    <?php $__currentLoopData = $purchase->purchase_lines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase_line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr <?php if(!empty($purchase_line->purchase_order_line) && !empty($common_settings['enable_purchase_order'])): ?> data-purchase_order_id="<?php echo e($purchase_line->purchase_order_line->transaction_id, false); ?>" <?php endif; ?>>
            ...
            <td>
                ...
                value="<?php echo e(number_format($purchase_line->quantity, config('constants.quantity_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?>"
...
<input type="hidden" id="row_count" value="<?php echo e($row_count, false); ?>"><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/purchase/partials/edit_purchase_entry_row.blade.php ENDPATH**/ ?>