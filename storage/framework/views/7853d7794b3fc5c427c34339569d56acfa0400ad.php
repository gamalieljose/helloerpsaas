...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('manufacturing::lang.recipe'); ?></h1>
</section>
            ...
            <table class="table table-bordered table-striped" id="recipe_table">
                <thead>
                    <tr>
                        ...
                        <th><?php echo app('translator')->getFromJson( 'manufacturing::lang.recipe' ); ?></th>
                        ...
                        <th><?php echo app('translator')->getFromJson( 'lang_v1.price' ); ?> <?php
                ...
                <tfoot>
                    <tr>
                        <td colspan="8">
                            <button type="button" class="btn btn-xs btn-danger" id="mass_update_product_price" ><?php echo app('translator')->getFromJson('manufacturing::lang.update_product_price'); ?></button> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Manufacturing/Providers/../Resources/views/recipe/index.blade.php ENDPATH**/ ?>