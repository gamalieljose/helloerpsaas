  ...
  <div class="box box-solid">
    ...
    <input type="hidden" name="sub_type" value="<?php echo e($sub_type, false); ?>">
      <div class="row">
        ...
        <?php endif; ?>
        <div class="col-sm-8 col-sm-offset-2">
          <button type="submit" class="btn btn-primary pull-right"><?php echo app('translator')->getFromJson('cash_register.open_register'); ?></button>
        </div>
        <?php else: ?>
        <div class="col-sm-8 col-sm-offset-2 text-center">
          <h3><?php echo app('translator')->getFromJson('lang_v1.no_location_access_found'); ?></h3>
        </div>
      <?php endif; ?>
      </div>
      <br><br><br>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/cash_register/create.blade.php ENDPATH**/ ?>