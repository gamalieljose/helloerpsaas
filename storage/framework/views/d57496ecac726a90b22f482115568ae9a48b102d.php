<div class="pos-tab-content">
     <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <div class="input-group-addon">
                        <label>
                        <input type="checkbox" name="custom_labels[purchase][is_custom_field_1_required]" value="1" <?php if(!empty($custom_labels['purchase']['is_custom_field_1_required']) && $custom_labels['purchase']['is_custom_field_1_required'] == 1): ?> checked <?php endif; ?> > <?php echo app('translator')->getFromJson('lang_v1.is_required'); ?></label>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <div class="input-group-addon">
                        <label>
                        <input type="checkbox" name="custom_labels[purchase][is_custom_field_2_required]" value="1" <?php if(!empty($custom_labels['purchase']['is_custom_field_2_required']) && $custom_labels['purchase']['is_custom_field_2_required'] == 1): ?> checked <?php endif; ?> > <?php echo app('translator')->getFromJson('lang_v1.is_required'); ?></label>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <div class="input-group-addon">
                        <label>
                        <input type="checkbox" name="custom_labels[purchase][is_custom_field_3_required]" value="1" <?php if(!empty($custom_labels['purchase']['is_custom_field_3_required']) && $custom_labels['purchase']['is_custom_field_3_required'] == 1): ?> checked <?php endif; ?> > <?php echo app('translator')->getFromJson('lang_v1.is_required'); ?></label>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <div class="input-group-addon">
                        <label>
                        <input type="checkbox" name="custom_labels[purchase][is_custom_field_4_required]" value="1" <?php if(!empty($custom_labels['purchase']['is_custom_field_4_required']) && $custom_labels['purchase']['is_custom_field_4_required'] == 1): ?> checked <?php endif; ?> > <?php echo app('translator')->getFromJson('lang_v1.is_required'); ?></label>
                    </div>
                </div>
            </div>
        </div>
        <div class="clearfix"></div>
                <div class="col-sm-12">
            <h4><?php echo app('translator')->getFromJson('lang_v1.labels_for_purchase_shipping_custom_fields'); ?>:</h4>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <?php echo Form::text('custom_labels[purchase_shipping][custom_field_1]', !empty($custom_labels['purchase_shipping']['custom_field_1']) ? $custom_labels['purchase_shipping']['custom_field_1'] : null, 
                    ...
                    <div class="input-group-addon">
                        <label>
                        <input type="checkbox" name="custom_labels[purchase_shipping][is_custom_field_1_required]" value="1" <?php if(!empty($custom_labels['purchase_shipping']['is_custom_field_1_required']) && $custom_labels['purchase_shipping']['is_custom_field_1_required'] == 1): ?> checked <?php endif; ?> > <?php echo app('translator')->getFromJson('lang_v1.is_required'); ?></labe>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <?php echo Form::text('custom_labels[purchase_shipping][custom_field_2]', !empty($custom_labels['purchase_shipping']['custom_field_2']) ? $custom_labels['purchase_shipping']['custom_field_2'] : null, 
                    ...
                    <div class="input-group-addon">
                        <label>
                        <input type="checkbox" name="custom_labels[purchase_shipping][is_custom_field_2_required]" value="1" <?php if(!empty($custom_labels['purchase_shipping']['is_custom_field_2_required']) && $custom_labels['purchase_shipping']['is_custom_field_2_required'] == 1): ?> checked <?php endif; ?> > <?php echo app('translator')->getFromJson('lang_v1.is_required'); ?></label>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <?php echo Form::text('custom_labels[purchase_shipping][custom_field_3]', !empty($custom_labels['purchase_shipping']['custom_field_3']) ? $custom_labels['purchase_shipping']['custom_field_3'] : null, 
                    ...
                    <div class="input-group-addon">
                        <label>
                        <input type="checkbox" name="custom_labels[purchase_shipping][is_custom_field_3_required]" value="1" <?php if(!empty($custom_labels['purchase_shipping']['is_custom_field_3_required']) && $custom_labels['purchase_shipping']['is_custom_field_3_required'] == 1): ?> checked <?php endif; ?> > <?php echo app('translator')->getFromJson('lang_v1.is_required'); ?></label>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <?php echo Form::text('custom_labels[purchase_shipping][custom_field_4]', !empty($custom_labels['purchase_shipping']['custom_field_4']) ? $custom_labels['purchase_shipping']['custom_field_4'] : null, 
                    ...
                    <div class="input-group-addon">
                        <label>
                        <input type="checkbox" name="custom_labels[purchase_shipping][is_custom_field_4_required]" value="1" <?php if(!empty($custom_labels['purchase_shipping']['is_custom_field_4_required']) && $custom_labels['purchase_shipping']['is_custom_field_4_required'] == 1): ?> checked <?php endif; ?> > <?php echo app('translator')->getFromJson('lang_v1.is_required'); ?></label>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <?php echo Form::text('custom_labels[purchase_shipping][custom_field_5]', !empty($custom_labels['purchase_shipping']['custom_field_5']) ? $custom_labels['purchase_shipping']['custom_field_5'] : null, 
                    ...
                    <div class="input-group-addon">
                        <label>
                        <input type="checkbox" name="custom_labels[purchase_shipping][is_custom_field_5_required]" value="1" <?php if(!empty($custom_labels['purchase_shipping']['is_custom_field_5_required']) && $custom_labels['purchase_shipping']['is_custom_field_5_required'] == 1): ?> checked <?php endif; ?> > <?php echo app('translator')->getFromJson('lang_v1.is_required'); ?></label>
                    </div>
                </div>
            </div>
        </div>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/business/partials/settings_custom_labels.blade.php ENDPATH**/ ?>