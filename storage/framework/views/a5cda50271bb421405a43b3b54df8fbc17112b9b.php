...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('manufacturing::lang.add_ingredients'); ?></h1>
</section>
...
<section class="content">
	...
	<div class="box box-solid">
		<div class="box-header"> 
			<h4 class="box-title"><strong><?php echo app('translator')->getFromJson('sale.product'); ?>: </strong><?php echo e($variation->product_name, false); ?> <?php if($variation->product_type == 'variable'): ?> - <?php echo e($variation->product_variation_name, false); ?> - <?php echo e($variation->name, false); ?> <?php endif; ?></h4>
		</div>
		<div class="box-body">
			<div class="row">
				<div class="col-md-12">
					<button type="button" class="btn btn-success pull-right" id="add_ingredient_group"><?php echo app('translator')->getFromJson('manufacturing::lang.add_ingredient_group'); ?> <?php
		...
		<div class="box-body">
			<div class="row">
				...
				<div class="col-md-12 text-right">
					<strong><?php echo app('translator')->getFromJson('manufacturing::lang.ingredients_cost'); ?>: </strong> <span 
                ...
                ?>
						<div class="input_inline">
							...
							<span>
								<?php echo Form::select('production_cost_type',['fixed' => __('lang_v1.fixed'), 'percentage' => __('lang_v1.percentage'), 'per_unit' => __('manufacturing::lang.per_unit')], !empty($recipe->production_cost_type) ? $recipe->production_cost_type : 'fixed', ['class' => 'form-control', 'id' => 'production_cost_type']);; ?>	
							</span>
						</div>
						<p><strong>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Manufacturing/Providers/../Resources/views/recipe/add_ingredients.blade.php ENDPATH**/ ?>