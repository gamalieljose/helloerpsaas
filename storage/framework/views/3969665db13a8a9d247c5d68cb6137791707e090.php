	...
	<thead>
		<tr>
			...
			<p class="text-right color-555">
				<?php echo app('translator')->getFromJson('lang_v1.packing_slip'); ?>
			</p>
...
<div class="row invoice-info color-555">
	...
	<div class="col-md-6 invoice-col width-50 word-wrap">
		<strong><?php echo app('translator')->getFromJson('lang_v1.shipping_address'); ?>:</strong><br>
...
</table><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/sale_pos/receipts/packing_slip.blade.php ENDPATH**/ ?>