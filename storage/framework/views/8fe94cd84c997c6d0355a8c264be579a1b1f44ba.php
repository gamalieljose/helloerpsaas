		...
		<div class="small-box bg-gray">
            <div class="inner">
            	...
            	<table class="table no-margin no-border table-slim">
            		...
            		<tr><th><?php echo app('translator')->getFromJson('restaurant.order_status'); ?></th>
                              <?php
                              ...
                              ?>
                              <td><span class="label <?php if($order_status == 'cooked' ): ?> bg-red <?php elseif($order_status == 'served'): ?> bg-green <?php elseif($order_status == 'partial_cooked'): ?> bg-orange <?php else: ?> bg-light-blue <?php endif; ?>"><?php echo app('translator')->getFromJson('restaurant.order_statuses.' . $order_status); ?> </span></td>
                        </tr>
            ...
            <?php elseif($orders_for == 'waiter' && $order->res_order_status != 'served'): ?>
            	<a href="#" class="btn btn-flat small-box-footer bg-yellow mark_as_served_btn" data-href="<?php echo e(action('Restaurant\OrderController@markAsServed', [$order->id]), false); ?>"><i class="fa fa-check-square-o"></i> <?php echo app('translator')->getFromJson('restaurant.mark_as_served'); ?></a>
            <?php else: ?>
            	<div class="small-box-footer bg-gray">&nbsp;</div>
            <?php endif; ?>
            	<a href="#" class="btn btn-flat small-box-footer bg-info btn-modal" data-href="<?php echo e(action('SellController@show', [$order->id]), false); ?>" data-container=".view_modal"><?php echo app('translator')->getFromJson('restaurant.order_details'); ?> <i class="fa fa-arrow-circle-right"></i></a>
         </div>
	</div>
...
<?php endif; ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/restaurant/partials/show_orders.blade.php ENDPATH**/ ?>