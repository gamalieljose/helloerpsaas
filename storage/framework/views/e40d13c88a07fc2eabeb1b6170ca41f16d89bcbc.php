        ...
        <?php $__env->startComponent('components.widget', ['title' => __('lang_v1.profile_photo')]); ?>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <small><p class="help-block"><?php echo app('translator')->getFromJson('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)]); ?></p></small>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/user/profile.blade.php ENDPATH**/ ?>