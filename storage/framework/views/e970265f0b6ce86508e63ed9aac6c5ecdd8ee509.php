...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson( 'tax_rate.tax_rates' ); ?>
        <small><?php echo app('translator')->getFromJson( 'tax_rate.manage_your_tax_rates' ); ?></small>
    </h1>
</section>
...
<section class="content">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('tax_rate.view')): ?>
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="tax_rates_table">
                    <thead>
                        <tr>
                            <th><?php echo app('translator')->getFromJson( 'tax_rate.name' ); ?></th>
                            <th><?php echo app('translator')->getFromJson( 'tax_rate.rate' ); ?></th>
    ...
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
        <?php $__env->slot('title'); ?>
            <?php echo app('translator')->getFromJson( 'tax_rate.tax_groups' ); ?> ( <?php echo app('translator')->getFromJson('lang_v1.combination_of_taxes'); ?> ) <?php
                ...
                <table class="table table-bordered table-striped" id="tax_groups_table">
                    <thead>
                        <tr>
                            <th><?php echo app('translator')->getFromJson( 'tax_rate.name' ); ?></th>
                            <th><?php echo app('translator')->getFromJson( 'tax_rate.rate' ); ?></th>
                            <th><?php echo app('translator')->getFromJson( 'tax_rate.sub_taxes' ); ?></th>
                            <th><?php echo app('translator')->getFromJson( 'messages.action' ); ?></th>
                        </tr>
                    </thead>
                </table>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/tax_rate/index.blade.php ENDPATH**/ ?>