...
<div class="row">
	<div class="col-md-12">
	    <button type="button" class="btn btn-primary center-block more_btn" data-target="#contact_person_div"><?php echo app('translator')->getFromJson('crm::lang.add_contact_persons'); ?> <i class="fa fa-chevron-down"></i></button>
	</div>
</div>
...
</div><?php /**PATH C:\laragon\www\helloerp\Modules\Crm\Providers/../Resources/views/contact_login/partial/contact_form_part.blade.php ENDPATH**/ ?>