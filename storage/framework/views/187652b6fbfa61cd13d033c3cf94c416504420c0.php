			...
			<div class="row">
				...
				<div class="col-sm-4">
					<div class="form-group">
						...
						<p class="help-block">
			                <?php echo app('translator')->getFromJson('lang_v1.leave_empty_to_autogenerate'); ?>
			            </p>
					</div>
				</div>
				...
				<div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <small><p class="help-block"><?php echo app('translator')->getFromJson('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)]); ?>
				...
				<div class="col-md-4 col-sm-6">
					<br>
					<label>
		              <?php echo Form::checkbox('is_refund', 1, false, ['class' => 'input-icheck', 'id' => 'is_refund']);; ?> <?php echo app('translator')->getFromJson('lang_v1.is_refund'); ?>?
		            </label><?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="pull-right">
					<strong><?php echo app('translator')->getFromJson('purchase.payment_due'); ?>:</strong>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/expense/create.blade.php ENDPATH**/ ?>