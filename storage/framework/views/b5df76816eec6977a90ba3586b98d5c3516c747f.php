<div class="modal fade" id="update_purchase_status_modal" tabindex="-1" role="dialog" 
	...
	<div class="modal-dialog" role="document">
		...
		<div class="modal-header">
			...
			<h4 class="modal-title"><?php echo app('translator')->getFromJson( 'lang_v1.update_status' ); ?></h4>
		</div>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/purchase/partials/update_purchase_status_modal.blade.php ENDPATH**/ ?>