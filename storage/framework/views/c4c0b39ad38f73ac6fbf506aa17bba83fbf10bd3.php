<tr>
	...
	<td>
		...
		<div class="<?php if(!empty($ingredient['sub_units'])): ?> input_inline <?php else: ?> input-group <?php endif; ?>">
			...
			value="<?php echo e(number_format($ingredient['quantity'], config('constants.quantity_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?>" 
	...
	<td>
		<div class="input-group">
			<input type="text" name="ingredients[<?php echo e($ingredient['id'], false); ?>][mfg_waste_percent]" value="<?php echo e(number_format($ingredient['waste_percent'], config('constants.quantity_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?>" class="form-control input-sm input_number mfg_waste_percent">
			<span class="input-group-addon"><i class="fa fa-percent"></i></span>
		</div>
	</td>
	<td>
		<span class="row_final_quantity"><?php echo e(number_format($ingredient['final_quantity'], config('constants.quantity_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?></span> <span class="row_unit_text"><?php echo e($ingredient['unit'], false); ?></span>
	</td>
	<td>
		<span class="ingredient_total_price display_currency" data-currency_symbol="true"><?php echo e(number_format($ingredient['total_price'], config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?></span>
		<input type="hidden" class="total_price" value="<?php echo e($ingredient['total_price'], false); ?>">
	</td>
</tr><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Manufacturing/Providers/../Resources/views/recipe/ingredient_row_for_production.blade.php ENDPATH**/ ?>