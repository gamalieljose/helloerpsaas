		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">
					<?php echo app('translator')->getFromJson('lang_v1.search_products_by'); ?>
				</h4>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-md-6">
						<div class="checkbox">
							<label>
				              	<?php echo Form::checkbox('search_fields[]', 'name', true, ['class' => 'input-icheck search_fields']);; ?> <?php echo app('translator')->getFromJson('product.product_name'); ?>
				            </label>
						</div>
					</div>
					<div class="col-md-6">
						<div class="checkbox">
							<label>
				              	<?php echo Form::checkbox('search_fields[]', 'sku', true, ['class' => 'input-icheck search_fields']);; ?> <?php echo app('translator')->getFromJson('product.sku'); ?>
				            </label>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="checkbox">
							<label>
				              	<?php echo Form::checkbox('search_fields[]', 'lot', true, ['class' => 'input-icheck search_fields']);; ?> <?php echo app('translator')->getFromJson('lang_v1.lot_number'); ?>
				            </label>
						</div>
					</div>
					<?php endif; ?>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/sale_pos/partials/configure_search_modal.blade.php ENDPATH**/ ?>