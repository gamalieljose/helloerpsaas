...
<section class="content-header">
    <h1>
        ...
        <?php echo app('translator')->getFromJson('messages.settings'); ?>
    </h1>
</section>
        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                ...
                if(session('business.enable_tooltip')){
                    ...
                    data-content="' . __('repair::lang.all_js_status_tooltip') . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>
                        </a>
                    </li>
                    <li>
                        <a href="#repair_device_tab" data-toggle="tab" aria-expanded="true">
                            ...
                            <?php echo app('translator')->getFromJson('repair::lang.devices'); ?>
                            <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="' . __('repair::lang.device_tooltip') . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>
                        </a>
                    </li>
                    <li>
                        <a href="#repair_device_models_tab" data-toggle="tab" aria-expanded="true">
                            ...
                            <?php echo app('translator')->getFromJson('repair::lang.device_models'); ?>
                            <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                    data-content="' . __('repair::lang.device_models_tooltip') . '" data-html="true" data-trigger="hover"></i>';
                }
                ?>
                        </a>
                    </li>
                    <li>
                        <a href="#repair_settings_tab" data-toggle="tab" aria-expanded="true">
                            ...
                            <?php echo app('translator')->getFromJson('repair::lang.repair_settings'); ?>
                        </a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active" id="repair_status_tab"> 
                        <?php if ($__env->exists('repair::status.index')) echo $__env->make('repair::status.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <!-- Device (Taxonomy)-->
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::select('brand_id', $brands, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]);; ?>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <?php echo Form::select('device_id', $devices, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all')]);; ?>

                                </div>
                            </div>
                        </div>
                        <?php if ($__env->exists('repair::device_model.index')) echo $__env->make('repair::device_model.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="tab-pane" id="repair_settings_tab"> 
                        <?php if ($__env->exists('repair::settings.partials.repair_settings_tab')) echo $__env->make('repair::settings.partials.repair_settings_tab', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
    ...
    $(document).ready( function(){
        ...
        $('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
            ...
            if ( target == '#repair_settings_tab') {
                ...
                <?php if(!empty($repair_settings['default_status'])): ?>
                    $("select#repair_status_id").val(<?php echo e($repair_settings['default_status'], false); ?>).change();
                <?php endif; ?>
        ...
        var status_table = $('#status_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(action('\Modules\Repair\Http\Controllers\RepairStatusController@index'), false); ?>",
                aaSorting: [[2, 'desc']],
                columnDefs: [ {
                    "targets": 3,
                    "orderable": false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Repair/Providers/../Resources/views/settings/index.blade.php ENDPATH**/ ?>