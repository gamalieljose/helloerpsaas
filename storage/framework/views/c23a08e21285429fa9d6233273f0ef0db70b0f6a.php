	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><?php echo app('translator')->getFromJson('lang_v1.subscribe'); ?> <?php if(!empty($transaction->subscription_no)): ?> - <?php echo e($transaction->subscription_no, false); ?> <?php endif; ?></h4>
			</div>
				...
				<div class="row">
				    ...
				    <div class="col-md-6">
				        <div class="form-group">
					        ...
					        <p class="help-block"><?php echo app('translator')->getFromJson('lang_v1.recur_repetition_help'); ?></p>
				        </div>
				    </div>
				    <?php
				    	$repetitions = [];
...
</div><!-- /.modal --><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/sale_pos/partials/recurring_invoice_modal.blade.php ENDPATH**/ ?>