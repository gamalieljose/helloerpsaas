...
<section class="content-header">
  <h1><?php echo app('translator')->getFromJson( 'user.add_user' ); ?></h1>
</section>
...
<?php echo Form::open(['url' => action('ManageUserController@store'), 'method' => 'post', 'id' => 'user_add_form' ]); ?>
    ...
    <?php $__env->startComponent('components.widget', ['title' => __('lang_v1.roles_and_permissions')]); ?>
      ...
      <div class="col-md-4">
        <div class="form-group">
          ...
          <?php endif; ?>
          <p class="help-block"><?php echo app('translator')->getFromJson('lang_v1.username_help'); ?></p>
        </div>
      </div>
      <div class="col-md-4">
        <div class="form-group">
  ...
  <div class="row">
    <div class="col-md-12 text-center">
      <button type="submit" class="btn btn-primary btn-big" id="submit_user_button"><?php echo app('translator')->getFromJson( 'messages.save' ); ?></button>
    </div>
  </div>
<?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/manage_user/create.blade.php ENDPATH**/ ?>