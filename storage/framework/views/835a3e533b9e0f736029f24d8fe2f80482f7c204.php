<div class="modal fade" id="update_password_modal" tabindex="-1" role="dialog" 
    ...
    <div class="modal-dialog" role="document">
	    ...
	    <div class="modal-header">
	      ...
	      <h4 class="modal-title"><span id="user_name"></span> - <?php echo app('translator')->getFromJson( 'superadmin::lang.update_password' ); ?></h4>
	    </div>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Superadmin/Providers/../Resources/views/business/update_password_modal.blade.php ENDPATH**/ ?>