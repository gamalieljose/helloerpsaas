<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo app('translator')->getFromJson( 'unit.edit_unit' ); ?></h4>
    </div>
      ...
      <div class="row">
        ...
        <div class="form-group col-sm-12">
            <div class="form-group">
                <div class="checkbox">
                  <label>
                     <?php echo Form::checkbox('define_base_unit', 1, !empty($unit->base_unit_id),[ 'class' => 'toggler', 'data-toggle_id' => 'base_unit_div' ]);; ?> <?php echo app('translator')->getFromJson( 'lang_v1.add_as_multiple_of_base_unit' ); ?>
                  </label> <?php
        ...
        <div class="form-group col-sm-12 <?php if(empty($unit->base_unit_id)): ?> hide <?php endif; ?>" id="base_unit_div">
          <table class="table">
            ...
            <p class="help-block">*<?php echo app('translator')->getFromJson('lang_v1.edit_multi_unit_help_text'); ?></p></td></tr>
          </table>
        </div>
      </div>
    </div>
...
</div><!-- /.modal-dialog --><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/unit/edit.blade.php ENDPATH**/ ?>