<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo app('translator')->getFromJson( 'repair::lang.add_status' ); ?></h4>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mt-15">
                <div class="form-group">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" name="is_completed_status" value="1" id="is_completed_status"> <?php echo app('translator')->getFromJson('repair::lang.mark_this_status_as_complete'); ?>
                        </label>
                    </div>
                </div>
            </div>
...
</div><!-- /.modal-dialog --><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Repair/Providers/../Resources/views/status/create.blade.php ENDPATH**/ ?>