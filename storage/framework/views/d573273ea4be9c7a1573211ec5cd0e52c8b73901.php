...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson( 'brand.brands' ); ?>
        <small><?php echo app('translator')->getFromJson( 'brand.manage_your_brands' ); ?></small>
    </h1>
    <!-- <ol class="breadcrumb">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/brand/index.blade.php ENDPATH**/ ?>