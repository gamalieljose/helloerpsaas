...
<section class="content-header">
	<h1>
    	<?php echo app('translator')->getFromJson('project::lang.projects'); ?>
    	<small> <?php echo app('translator')->getFromJson('project::lang.all_projects'); ?></small>
    </h1>
</section>
<!-- Main content -->
<section class="content">
	...
	<div class="box box-solid">
		<div class="box-header with-border">
			<h3 class="box-title"><?php echo app('translator')->getFromJson('project::lang.projects'); ?></h3>
			<div class="box-tools pull-right">
				...
				<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('project.create_project')): ?>
					<button type="button" class="btn btn-primary btn-sm add_new_project" data-href="<?php echo e(action('\Modules\Project\Http\Controllers\ProjectController@create'), false); ?>">
						<?php echo app('translator')->getFromJson('project::lang.new_project'); ?>&nbsp;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Project/Providers/../Resources/views/project/index.blade.php ENDPATH**/ ?>