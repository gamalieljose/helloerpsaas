...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson( 'sale.discount' ); ?>
    </h1>
...
<section class="content">
	...
	<div class="box">
        <div class="box-header">
        	<h3 class="box-title"><?php echo app('translator')->getFromJson('lang_v1.all_your_discounts'); ?></h3>
            	...
            	<table class="table table-bordered table-striped" id="discounts_table">
            		<thead>
            			<tr>
            				...
            				<th><?php echo app('translator')->getFromJson( 'unit.name' ); ?></th>
            				<th><?php echo app('translator')->getFromJson( 'lang_v1.starts_at' ); ?></th>
            				<th><?php echo app('translator')->getFromJson( 'lang_v1.ends_at' ); ?></th>
                            <th><?php echo app('translator')->getFromJson( 'sale.discount_amount' ); ?></th>
                            <th><?php echo app('translator')->getFromJson( 'lang_v1.priority' ); ?></th>
                            <th><?php echo app('translator')->getFromJson( 'product.brand' ); ?></th>
                            <th><?php echo app('translator')->getFromJson( 'product.category' ); ?></th>
                            <th><?php echo app('translator')->getFromJson( 'report.products' ); ?></th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/discount/index.blade.php ENDPATH**/ ?>