...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('superadmin::lang.packages'); ?> <small><?php echo app('translator')->getFromJson('superadmin::lang.all_packages'); ?></small></h1>
    <!-- <ol class="breadcrumb">
					...
					<div class="box box-success hvr-grow-shadow">
							...
							<div class="row">
								<?php if($package->is_private): ?>
									<a href="#!" class="btn btn-box-tool">
										...
										title="<?php echo app('translator')->getFromJson('superadmin::lang.private_superadmin_only'); ?>"></i>
									</a>
								<?php endif; ?>
								...
								<?php if($package->is_one_time): ?>
									<a href="#!" class="btn btn-box-tool">
										...
										title="<?php echo app('translator')->getFromJson('superadmin::lang.one_time_only_subscription'); ?>"></i>
									</a>
								<?php endif; ?>
								
								<?php if($package->is_active == 1): ?>
									<span class="badge bg-green">
										<?php echo app('translator')->getFromJson('superadmin::lang.active'); ?>
									</span>
								<?php else: ?>
									<span class="badge bg-red">
									<?php echo app('translator')->getFromJson('superadmin::lang.inactive'); ?>
									</span>
								<?php endif; ?>
						...
						<div class="box-body text-center">
							...
							<?php if($package->trial_days != 0): ?>
									<?php echo e($package->trial_days, false); ?> <?php echo app('translator')->getFromJson('superadmin::lang.trial_days'); ?>
								<br/>
							<?php endif; ?>
							...
							<h3 class="text-center">
								...
								<?php else: ?>
									<?php echo app('translator')->getFromJson('superadmin::lang.free_for_duration', ['duration' => $package->interval_count . ' ' . __('lang_v1.' . $package->interval)]); ?>
								<?php endif; ?>
							</h3>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Superadmin/Providers/../Resources/views/packages/index.blade.php ENDPATH**/ ?>