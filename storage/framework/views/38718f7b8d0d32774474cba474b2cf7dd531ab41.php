...
<section class="content no-print">
    ...
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
        <?php $__env->slot('tool'); ?>
            <div class="box-tools">
                <a class="btn btn-block btn-primary" href="<?php echo e(action('SellController@create', ['status' => 'quotation']), false); ?>">
                <i class="fa fa-plus"></i> <?php echo app('translator')->getFromJson('lang_v1.add_quotation'); ?></a>
            </div>
        <?php $__env->endSlot(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/sale_pos/quotations.blade.php ENDPATH**/ ?>