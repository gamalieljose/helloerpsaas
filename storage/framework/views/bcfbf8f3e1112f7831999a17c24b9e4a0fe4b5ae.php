    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">
            <?php echo app('translator')->getFromJson('repair::lang.security_pattern'); ?>
        </h4>
      </div>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Repair/Providers/../Resources/views/job_sheet/partials/scurity_modal.blade.php ENDPATH**/ ?>