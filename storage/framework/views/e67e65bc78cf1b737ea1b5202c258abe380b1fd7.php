            ...
            <div class="inner">
            	...
            	<table class="table no-margin no-border table-slim">
            		...
            		<tr><th><?php echo app('translator')->getFromJson('restaurant.table'); ?></th><td><?php echo e($order->table_name, false); ?></td></tr>
                        <tr><th><?php echo app('translator')->getFromJson('restaurant.service_staff'); ?></th><td><?php echo e($order->service_staff_name ?? '', false); ?></td></tr>
            		<tr><th><?php echo app('translator')->getFromJson('sale.location'); ?></th><td><?php echo e($order->business_location, false); ?></td></tr>
                        ...
                        <tr><th><?php echo app('translator')->getFromJson('lang_v1.description'); ?></th><td> <?php echo nl2br($order->sell_line_note ?? ''); ?></td></tr>
            	</table>
            </div>
...
<?php endif; ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/restaurant/partials/line_orders.blade.php ENDPATH**/ ?>