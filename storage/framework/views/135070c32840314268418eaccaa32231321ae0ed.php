<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo app('translator')->getFromJson( 'account.link_account' ); ?> - <?php echo app('translator')->getFromJson( 'account.payment_ref_no' ); ?>: - <?php echo e($payment->payment_ref_no, false); ?></h4>
    </div>
...
</div><!-- /.modal-dialog --><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/account_reports/link_account_modal.blade.php ENDPATH**/ ?>