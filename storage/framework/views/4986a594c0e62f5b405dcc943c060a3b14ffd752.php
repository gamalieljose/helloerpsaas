...
<div class="col-sm-12">
<h4><?php echo app('translator')->getFromJson('product.add_variation'); ?>:* <button type="button" class="btn btn-primary" id="add_variation" data-action="add">+</button></h4>
</div>
<div class="col-sm-12">
    ...
    <table class="table table-bordered add-product-price-table table-condensed" id="product_variation_form_part">
        <thead>
          <tr>
            <th class="col-sm-2"><?php echo app('translator')->getFromJson('lang_v1.variation'); ?></th>
            <th class="col-sm-10"><?php echo app('translator')->getFromJson('product.variation_values'); ?></th>
          </tr>
        </thead>
        <tbody>
            <?php if($action == 'add'): ?>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/product/partials/variable_product_form_part.blade.php ENDPATH**/ ?>