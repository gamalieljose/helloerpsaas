        ...
        <div class="col-xs-4">
            <div class="form-group">
                <label>
                    ...
                    [ 'class' => 'input-icheck']);; ?> <?php echo e(__( 'superadmin::lang.enable_business_based_username' ), false); ?>

                </label>
                <p class="help-block"><?php echo app('translator')->getFromJson('superadmin::lang.business_based_username_help'); ?></p>
            </div>
        </div>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Superadmin/Providers/../Resources/views/superadmin_settings/partials/super_admin_settings.blade.php ENDPATH**/ ?>