		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<table class="table table-bordered table-striped table-condensed" id="product_table">
					<thead>
						<tr>
							<th><?php echo app('translator')->getFromJson( 'barcode.products' ); ?></th>
							<th><?php echo app('translator')->getFromJson( 'barcode.no_of_labels' ); ?></th>
							...
							<?php endif; ?>
							<th><?php echo app('translator')->getFromJson('lang_v1.packing_date'); ?></th>
						</tr>
					</thead>
					<tbody>
	...
	<?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'title' => __( 'barcode.info_in_labels' )]); ?>
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="checkbox">
				    <label>
				    	<input type="checkbox" checked name="print[lot_number]" value="1"> <b><?php echo app('translator')->getFromJson( 'lang_v1.print_lot_number' ); ?></b>
				    </label>
				</div>
			</div>
			<?php endif; ?>
			...
			<div class="col-sm-3">
				<div class="checkbox">
				    <label>
				    	<input type="checkbox" checked name="print[exp_date]" value="1"> <b><?php echo app('translator')->getFromJson( 'lang_v1.print_exp_date' ); ?></b>
				    </label>
				</div>
			</div>
			<?php endif; ?>
			...
			<div class="col-sm-3">
				<div class="checkbox">
				    <label>
				    	<input type="checkbox" checked name="print[packing_date]" value="1"> <b><?php echo app('translator')->getFromJson( 'lang_v1.print_packing_date' ); ?></b>
				    </label>
				</div>
			</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/labels/show.blade.php ENDPATH**/ ?>