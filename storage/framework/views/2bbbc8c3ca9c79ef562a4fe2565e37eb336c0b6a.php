...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('essentials::lang.payroll'); ?>
    </h1>
</section>
<!-- Main content -->
                    ...
                    <table class="table table-bordered table-striped" id="payrolls_table">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo app('translator')->getFromJson( 'essentials::lang.department' ); ?></th>
                                <th><?php echo app('translator')->getFromJson( 'essentials::lang.designation' ); ?></th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Essentials/Providers/../Resources/views/payroll/index.blade.php ENDPATH**/ ?>