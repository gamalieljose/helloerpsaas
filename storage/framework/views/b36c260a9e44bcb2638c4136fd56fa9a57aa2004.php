                ...
                <div class="box-body p-10">
                    <table class="table no-margin">
                    	<thead>
                    		<tr>
                    			<th colspan="2">
                    				<?php echo app('translator')->getFromJson('essentials::lang.my_leaves'); ?>
                    			</th>
                    		</tr>
                    		...
                    		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    			<tr>
	                    			<td colspan="2" class="text-center">
	                    				<?php echo app('translator')->getFromJson('lang_v1.no_data'); ?>
	                    			</td>
	                    		</tr>
                    		<?php endif; ?>
                    	</thead>
	            ...
	            <div class="box-body p-10">
	                ...
	                <table class="table no-margin">
	                    ...
	                    <tbody>
	                        ...
	                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
	                            <tr>
	                                <td colspan="2" class="text-center"><?php echo app('translator')->getFromJson('lang_v1.no_data'); ?></td>
	                            </tr>
	                        <?php endif; ?>
	                    </tbody>
	                </table>
    	...
    	<div class="col-md-4 col-sm-6 col-xs-12 col-custom">
            <div class="box box-solid">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title"><?php echo app('translator')->getFromJson('essentials::lang.leaves'); ?></h3>
                </div>
                <div class="box-body p-10">
                    <table class="table no-margin">
                        <tr>
                            <th class="bg-light-gray" colspan="2"><?php echo app('translator')->getFromJson('home.today'); ?></th>
                        </tr>
                        ...
                        <tr>
                            <th class="bg-light-gray" colspan="2"><?php echo app('translator')->getFromJson('lang_v1.upcoming'); ?></th>
                        </tr>
    		...
    		<div class="col-md-4 col-sm-6 col-xs-12 col-custom">
	        	<div class="box box-solid">
	        		<div class="box-header with-border">
	                    ...
	                    <h3 class="box-title"><?php echo app('translator')->getFromJson('essentials::lang.todays_attendance'); ?></h3>
	                </div>
	                <div class="box-body p-10">
	                    <table class="table no-margin">
	                    	<thead>
	                    		<tr>
	                    			<th>
	                    				<?php echo app('translator')->getFromJson('essentials::lang.employee'); ?>
	                    			</th>
	                    			<th>
	                    				<?php echo app('translator')->getFromJson('essentials::lang.clock_in'); ?>
	                    			</th>
	                    			<th>
	                    				<?php echo app('translator')->getFromJson('essentials::lang.clock_out'); ?>
	                    			</th>
	                    		</tr>
	                    	</thead>
	                        <tbody>
	                            ...
	                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
	                                <tr>
	                                    <td colspan="3" class="text-center"><?php echo app('translator')->getFromJson('lang_v1.no_data'); ?></td>
	                                </tr>
	                            <?php endif; ?>
	                        </tbody>
	                    </table>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Essentials/Providers/../Resources/views/dashboard/hrm_dashboard.blade.php ENDPATH**/ ?>