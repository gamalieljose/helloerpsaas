                ...
                <ul class="nav nav-tabs">
                    <li class="
                        ...
                        <?php else: ?>
                            ''
                        <?php endif; ?>">
                        <a href="#project_overview" data-toggle="tab" aria-expanded="true" data-url="<?php echo e(action('\Modules\Project\Http\Controllers\ProjectController@show', ['id' => $project->id]).'?view=overview', false); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Project/Providers/../Resources/views/project/show.blade.php ENDPATH**/ ?>