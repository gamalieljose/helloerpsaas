                    ...
                    id="items_report_table">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo app('translator')->getFromJson('purchase.purchase_date'); ?></th>
                                <th><?php echo app('translator')->getFromJson('lang_v1.purchase'); ?></th>
                                <th><?php echo app('translator')->getFromJson('purchase.supplier'); ?></th>
                                <th><?php echo app('translator')->getFromJson('lang_v1.purchase_price'); ?></th>
                                <th><?php echo app('translator')->getFromJson('lang_v1.sell_date'); ?></th>
                                <th><?php echo app('translator')->getFromJson('business.sale'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/report/items_report.blade.php ENDPATH**/ ?>