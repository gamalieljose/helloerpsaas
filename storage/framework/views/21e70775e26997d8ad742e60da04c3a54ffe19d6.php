  ...
  <div class="col-sm-12">
    <table class="table table-condensed">
      <tr>
        ...
        <th><?php echo app('translator')->getFromJson('sale.sale'); ?></th>
        <th><?php echo app('translator')->getFromJson('lang_v1.expense'); ?></th>
      </tr>
      <tr>
        <td>
    ...
    <table class="table table-condensed">
      ...
      <tr class="danger">
        <th>
          <?php echo app('translator')->getFromJson('report.total_expense'); ?>:
        </th>
        <td>
...
<?php echo $__env->make('cash_register.register_product_details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/cash_register/payment_details.blade.php ENDPATH**/ ?>