...
<section class="content">
  ...
  <?php echo Form::open(['url' =>  action('PurchaseOrderController@update' , [$purchase->id] ), 'method' => 'PUT', 'id' => 'add_purchase_form', 'files' => true ]); ?>
  ...
  <input type="hidden" id="purchase_id" value="<?php echo e($purchase->id, false); ?>">
          ...
          <div class="row">
            <div class="col-md-4 col-md-offset-8">
                <?php echo Form::hidden('final_total', $purchase->final_total , ['id' => 'grand_total_hidden']);; ?>
                      ...
                      <b><?php echo app('translator')->getFromJson('lang_v1.order_total'); ?>: </b><span id="grand_total" class="display_currency" data-currency_symbol='true'><?php echo e($purchase->final_total, false); ?></span>
            </div>
          </div>
    <?php echo $__env->renderComponent(); ?>
    <?php $__env->startComponent('components.widget', ['class' => 'box-solid']); ?>
                  ...
                  <tr class="hide">
                    <td>
                      ...
                      <select name="tax_id" id="tax_id" class="form-control select2" placeholder="'Please Select'">
                        <option value="" data-tax_amount="0" selected><?php echo app('translator')->getFromJson('lang_v1.none'); ?></option>
    ...
    <div class="row">
        <div class="col-sm-12">
          <button type="button" id="submit_purchase_form" class="btn btn-primary pull-right btn-flat"><?php echo app('translator')->getFromJson('messages.update'); ?></button>
        </div>
    </div>
<?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/purchase_order/edit.blade.php ENDPATH**/ ?>