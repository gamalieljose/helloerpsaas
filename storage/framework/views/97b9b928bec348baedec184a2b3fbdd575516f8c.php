    ...
    <table class="table table-bordered table-striped" id="project_task_table">
        <thead>
            <tr>
                ...
                <th class="col-md-4"> <?php echo app('translator')->getFromJson('project::lang.subject'); ?></th>
                <th class="col-md-2"> <?php echo app('translator')->getFromJson('project::lang.assigned_to'); ?></th>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Project/Providers/../Resources/views/task/index.blade.php ENDPATH**/ ?>