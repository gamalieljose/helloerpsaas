...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('essentials::lang.attendance'); ?>
    </h1>
</section>
<!-- Main content -->
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <button 
                    ...
                    data-type="clock_in"
                    >
                    <i class="fas fa-arrow-circle-down"></i> <?php echo app('translator')->getFromJson('essentials::lang.clock_in'); ?>
                </button>
            &nbsp;&nbsp;&nbsp;
                <button 
                    type="button" 
                    ...
                    data-type="clock_out"
                    >
                    <i class="fas fa-hourglass-half fa-spin"></i> <?php echo app('translator')->getFromJson('essentials::lang.clock_out'); ?>
                </button>
                <?php if(!empty($clock_in)): ?>
                    <br>
                    <small class="text-muted"><?php echo app('translator')->getFromJson('essentials::lang.clocked_in_at'); ?>: <?php echo e(\Carbon::createFromTimestamp(strtotime($clock_in->clock_in_time))->format(session('business.date_format') . ' ' . 'H:i'), false); ?></small>
                <?php endif; ?>
            </div>
        </div>
    <?php endif; ?>
            ...
            <div class="nav-tabs-custom">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('essentials.crud_all_attendance')): ?>
                        <li class="active">
                            <a href="#shifts_tab" data-toggle="tab" aria-expanded="true">
                                ...
                                <?php echo app('translator')->getFromJson('essentials::lang.shifts'); ?>
                                <?php
                ...
                ?>
                    ...
                    <li <?php if(!auth()->user()->can('essentials.crud_all_attendance')): ?> class="active" <?php endif; ?>>
                        <a href="#attendance_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-check-square" aria-hidden="true"></i> <?php echo app('translator')->getFromJson( 'essentials::lang.all_attendance' ); ?></a>
                    </li>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('essentials.crud_all_attendance')): ?>
                    <li>
                        <a href="#attendance_by_shift_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-user-check" aria-hidden="true"></i> <?php echo app('translator')->getFromJson('essentials::lang.attendance_by_shift'); ?></a>
                    </li>
                    <li>
                        <a href="#attendance_by_date_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-calendar" aria-hidden="true"></i> <?php echo app('translator')->getFromJson('essentials::lang.attendance_by_date'); ?></a>
                    </li>
                    <li>
                        <a href="#import_attendance_tab" data-toggle="tab" aria-expanded="true"><i class="fas fa-download" aria-hidden="true"></i> <?php echo app('translator')->getFromJson('essentials::lang.import_attendance'); ?></a>
                    </li>
                    <?php endif; ?>
                </ul>
                <div class="tab-content">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('essentials.crud_all_attendance')): ?>
                        <div class="tab-pane active" id="shifts_tab">
                            <button type="button" class="btn btn-primary pull-right"  data-toggle="modal" data-target="#shift_modal"> <i class="fa fa-plus"></i> <?php echo app('translator')->getFromJson( 'messages.add' ); ?></button>
                            <br>
                            <br>
                            <br>
                                ...
                                <table class="table table-bordered table-striped" id="shift_table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo app('translator')->getFromJson( 'essentials::lang.shift_type' ); ?></th>
                                            <th><?php echo app('translator')->getFromJson( 'restaurant.start_time' ); ?></th>
                                            <th><?php echo app('translator')->getFromJson( 'restaurant.end_time' ); ?></th>
                                            <th><?php echo app('translator')->getFromJson( 'essentials::lang.holiday' ); ?></th>
                    ...
                    <div class="tab-pane <?php if(!auth()->user()->can('essentials.crud_all_attendance')): ?> active <?php endif; ?>" id="attendance_tab">
                        <div class="row">
                            ...
                            <div class="col-md-6 spacer">
                                <button type="button" class="btn btn-primary btn-modal pull-right" data-href="<?php echo e(action('\Modules\Essentials\Http\Controllers\AttendanceController@create'), false); ?>" data-container="#attendance_modal">
                                    ...
                                    <?php echo app('translator')->getFromJson( 'essentials::lang.add_latest_attendance' ); ?>
                                </button>
                            </div>
                            <?php endif; ?>
                        </div>
                        <div id="user_attendance_summary" class="hide">
                            <h3>
                                <strong><?php echo app('translator')->getFromJson('essentials::lang.total_work_hours'); ?>:</strong>
                            ...
                            <table class="table table-bordered table-striped" id="attendance_table" style="width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo app('translator')->getFromJson('essentials::lang.clock_in'); ?></th>
                                        <th><?php echo app('translator')->getFromJson('essentials::lang.clock_out'); ?></th>
                                        <th><?php echo app('translator')->getFromJson('essentials::lang.work_duration'); ?></th>
                                        <th><?php echo app('translator')->getFromJson('essentials::lang.ip_address'); ?></th>
                                        <th><?php echo app('translator')->getFromJson('essentials::lang.shift'); ?></th>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('essentials.crud_all_attendance')): ?>
                                            <th><?php echo app('translator')->getFromJson( 'messages.action' ); ?></th>
                                        <?php endif; ?>
                                    </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Essentials/Providers/../Resources/views/attendance/index.blade.php ENDPATH**/ ?>