...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('printer.add_printer'); ?></h1>
    <!-- <ol class="breadcrumb">
        ...
        <div class="col-sm-12" id="port_div">
          <div class="form-group">
            <?php echo Form::label('port', __('printer.port') . ':*'); ?>
              ...
              <span class="help-block"><?php echo app('translator')->getFromJson('lang_v1.port_help'); ?></span>
          </div>
        </div>
        ...
        <div class="col-sm-12 hide" id="path_div">
          <div class="form-group">
            ...
            <span class="help-block">
              <b><?php echo app('translator')->getFromJson('lang_v1.connection_type_windows'); ?>: </b> <?php echo app('translator')->getFromJson('lang_v1.windows_type_help'); ?> <code>LPT1</code> (parallel) / <code>COM1</code> (serial). <br/>
              <b><?php echo app('translator')->getFromJson('lang_v1.connection_type_linux'); ?>: </b> <?php echo app('translator')->getFromJson('lang_v1.linux_type_help'); ?> <code>/dev/lp0</code> (parallel), <code>/dev/usb/lp1</code> (USB), <code>/dev/ttyUSB0</code> (USB-Serial), <code>/dev/ttyS0</code> (serial). <br/>
            </span>
          </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/printer/create.blade.php ENDPATH**/ ?>