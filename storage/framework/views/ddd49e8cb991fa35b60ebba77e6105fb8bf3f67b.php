        ...
        <div class="col-md-6">
            <div class="box box-solid">
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title"><?php echo app('translator')->getFromJson('crm::lang.birthdays'); ?></h3>
                    <a data-href="<?php echo e(action('\Modules\Crm\Http\Controllers\CampaignController@create'), false); ?>" class="btn btn-success btn-xs" id="wish_birthday">
                        ...
                        <?php echo app('translator')->getFromJson('crm::lang.send_wishes'); ?>
                    </a>
                </div>
                <div class="box-body p-10">
                    <table class="table no-margin table-striped">
                        <caption><?php echo app('translator')->getFromJson('home.today'); ?></caption>
                        <thead>
                            <tr>
                                <th>#</th>
                    ...
                    <table class="table no-margin table-striped">
                        <caption>
                            <?php echo app('translator')->getFromJson('crm::lang.upcoming'); ?>
                        </caption>
                        <thead>
                            <tr>
                                <th>#</th>
                                <th><?php echo app('translator')->getFromJson('user.name'); ?></th>
                                <th><?php echo app('translator')->getFromJson('crm::lang.birthday_on'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Crm/Providers/../Resources/views/crm_dashboard/index.blade.php ENDPATH**/ ?>