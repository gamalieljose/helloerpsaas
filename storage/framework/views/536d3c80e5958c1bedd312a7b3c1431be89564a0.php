<div class="modal-dialog" role="document">
	...
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title"><?php echo app('translator')->getFromJson('lang_v1.edit_shipping'); ?> - <?php if($transaction->type == 'purchase_order'): ?> <?php echo e($transaction->ref_no, false); ?> <?php else: ?> <?php echo e($transaction->invoice_no, false); ?> <?php endif; ?></h4>
		</div>
		        ...
		        <div class="col-md-12">
		        	<div class="form-group">
                        <label for="fileupload">
                            <?php echo app('translator')->getFromJson('lang_v1.shipping_documents'); ?>:
                        </label>
...
</div><!-- /.modal-dialog --><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/sell/partials/edit_shipping.blade.php ENDPATH**/ ?>