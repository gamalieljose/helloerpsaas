...
<section class="content">
	...
	<?php echo Form::open(['url' => action('PurchaseOrderController@store'), 'method' => 'post', 'id' => 'add_purchase_form', 'files' => true ]); ?>
					...
					<table class="table table-condensed table-bordered table-th-green text-center table-striped" id="purchase_entry_table">
						<thead>
							<tr>
								...
								<th><?php echo app('translator')->getFromJson( 'lang_v1.order_quantity' ); ?></th>
	...
	<div class="row">
		...
		<b><?php echo app('translator')->getFromJson('lang_v1.order_total'); ?>: </b><span id="grand_total" class="display_currency" data-currency_symbol='true'>0</span>
		</div>
	</div>
	<?php echo $__env->renderComponent(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/purchase_order/create.blade.php ENDPATH**/ ?>