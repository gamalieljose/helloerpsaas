...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('essentials::lang.essentials_n_hrm_settings'); ?></h1>
</section>
            ...
            <div class="col-xs-12 pos-tab-container">
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pos-tab-menu">
                    <div class="list-group">
                        <a href="#" class="list-group-item text-center active"><?php echo app('translator')->getFromJson('essentials::lang.leave'); ?></a>
                        <a href="#" class="list-group-item text-center"><?php echo app('translator')->getFromJson('essentials::lang.payroll'); ?></a>
                        <a href="#" class="list-group-item text-center"><?php echo app('translator')->getFromJson('essentials::lang.attendance'); ?></a>
                        <a href="#" class="list-group-item text-center"><?php echo app('translator')->getFromJson('essentials::lang.essentials'); ?></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Essentials/Providers/../Resources/views/settings/add.blade.php ENDPATH**/ ?>