...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('lang_v1.product_stock_history'); ?></h1>
</section>
...
<div class="row">
    ...
    <?php $__env->startComponent('components.widget', ['title' => $product->name]); ?>
        ...
        <?php if($product->type == 'variable'): ?>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="variation_id"><?php echo app('translator')->getFromJson('product.variations'); ?>:</label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/product/stock_history.blade.php ENDPATH**/ ?>