...
<section class="content-header">
  <h1><?php echo app('translator')->getFromJson( 'essentials::lang.add_payroll' ); ?></h1>
</section>
...
<?php echo Form::open(['url' => action('\Modules\Essentials\Http\Controllers\PayrollController@store'), 'method' => 'post', 'id' => 'add_payroll_form' ]); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <h4 class="pull-right"><?php echo app('translator')->getFromJson('essentials::lang.gross_amount'); ?>: <span id="gross_amount_text">0</span></h4>
            <br>
    ...
    <div class="row">
        <div class="col-md-12">
            <button type="submit" class="btn btn-primary pull-right" id="submit_user_button"><?php echo app('translator')->getFromJson( 'messages.save' ); ?></button>
        </div>
    </div>
<?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Essentials/Providers/../Resources/views/payroll/create.blade.php ENDPATH**/ ?>