<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <?php echo Form::open(['url' => action('BrandController@update', [$brand->id]), 'method' => 'PUT', 'id' => 'brand_edit_form' ]); ?>


    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <h4 class="modal-title"><?php echo app('translator')->getFromJson( 'brand.edit_brand' ); ?></h4>
    </div>
    ...
    <div class="modal-body">
      ...
      <div class="form-group">
        ...
        <?php if($is_repair_installed): ?>
          <div class="form-group">
             <label>
                <?php echo Form::checkbox('use_for_repair', 1, $brand->use_for_repair, ['class' => 'input-icheck']); ?>
...
</div><!-- /.modal-dialog --><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/brand/edit.blade.php ENDPATH**/ ?>