		...
		<table class="table table-bordered table-no-top-cell-border table-slim">
			<thead>
				<tr style="background-color: #357ca5 !important; color: white !important; font-size: 15px !important" class="table-no-side-cell-border table-no-top-cell-border text-center">
					...
					<td style="background-color: #357ca5 !important; color: white !important;width: 10% !important;">
						<?php echo e($receipt_details->table_unit_price_label, false); ?> (<?php echo app('translator')->getFromJson('product.inc_of_tax'); ?>)
					</td>
					<td style="background-color: #357ca5 !important; color: white !important;width: 10% !important;">
					...
					<tr>
						...
						<td>
                            ...
                            <?php if(!empty($line['sell_line_note'])): ?>
                            	<br>
                             <small class="text-muted"><?php echo e($line['sell_line_note'], false); ?></small>
                             <?php endif; ?>
...
<div class="row invoice-info color-555" style="page-break-inside: avoid !important">
	<div class="col-md-6 invoice-col width-50">
		...
		<b class="pull-left"><?php echo app('translator')->getFromJson('lang_v1.authorized_signatory'); ?></b>
	</div>
		...
		<?php if($receipt_details->show_barcode || $receipt_details->show_qr_code): ?>
			<div class="<?php if(!empty($receipt_details->footer_text)): ?> col-xs-4 <?php else: ?> col-xs-12 <?php endif; ?> text-center">
				...
				<?php if($receipt_details->show_qr_code && !empty($receipt_details->qr_code_details)): ?>
					...
					?>
					<img class="center-block mt-5" src="data:image/png;base64,<?php echo e(DNS2D::getBarcodePNG($qr_code_text, 'QRCODE', 3, 3, [39, 48, 54]), false); ?>">
				<?php endif; ?>
			</div>
		<?php endif; ?>
	</div>
...
</table><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/sale_pos/receipts/detailed.blade.php ENDPATH**/ ?>