<div class="row">
	<div class="col-md-12">
		<p><strong><?php echo app('translator')->getFromJson('sale.invoice_no'); ?>:</strong> <?php echo e($transaction->invoice_no, false); ?></p>
	</div>
	<div class="col-md-4">
			...
			<div class="input-group">
				...
				<span class="input-group-btn">
					...
					<?php if(isset($pos_settings['enable_weighing_scale']) && $pos_settings['enable_weighing_scale'] == 1): ?>
						...
						title="<?php echo app('translator')->getFromJson('lang_v1.weighing_scale'); ?>"><i class="fa fa-digital-tachograph text-primary fa-lg"></i></button>
					<?php endif; ?>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/sale_pos/partials/pos_form_edit.blade.php ENDPATH**/ ?>