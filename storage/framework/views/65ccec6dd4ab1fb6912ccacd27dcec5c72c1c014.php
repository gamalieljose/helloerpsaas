...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson( 'user.roles' ); ?>
        <small><?php echo app('translator')->getFromJson( 'user.manage_roles' ); ?></small>
    </h1>
    <!-- <ol class="breadcrumb">
    ...
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'title' => __( 'user.all_roles' )]); ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('roles.view')): ?>
            <table class="table table-bordered table-striped" id="roles_table">
                <thead>
                    <tr>
                        <th><?php echo app('translator')->getFromJson( 'user.roles' ); ?></th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/role/index.blade.php ENDPATH**/ ?>