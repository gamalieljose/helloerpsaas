...
<section class="content-header no-print">
   <h1><?php echo app('translator')->getFromJson('crm::lang.campaigns'); ?></h1>
</section>
        	...
        	<table class="table table-bordered table-striped" id="campaigns_table">
		        <thead>
		            <tr>
		                ...
		                <th><?php echo app('translator')->getFromJson('crm::lang.campaign_name'); ?></th>
		                <th><?php echo app('translator')->getFromJson('crm::lang.campaign_type'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Crm/Providers/../Resources/views/campaign/index.blade.php ENDPATH**/ ?>