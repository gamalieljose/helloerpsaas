...
<br>
    <h1><?php echo app('translator')->getFromJson('stock_adjustment.add'); ?></h1>
    <!-- <ol class="breadcrumb">
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					...
					id="stock_adjustment_product_table">
						...
						<tfoot>
							<tr class="text-center"><td colspan="3"></td><td><div class="pull-right"><b><?php echo app('translator')->getFromJson('stock_adjustment.total_amount'); ?>:</b> <span id="total_adjustment">0.00</span></div></td></tr>
						</tfoot>
					</table>
					</div>
				</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/stock_adjustment/create.blade.php ENDPATH**/ ?>