...
<section class="content">
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'title' => __( 'lang_v1.all_your_customer_groups' )]); ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('customer.view')): ?>
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="bankaccount_table">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo app('translator')->getFromJson( 'lang_v1.selling_price_group' ); ?></th>
                            <th><?php echo app('translator')->getFromJson( 'lang_v1.calculation_percentage' ); ?></th>
    ...
    <div class="modal fade bankaccount_modal" tabindex="-1" role="dialog" 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\helloerp\resources\views/bankaccount/index.blade.php ENDPATH**/ ?>