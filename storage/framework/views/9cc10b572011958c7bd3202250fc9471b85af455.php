...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson( 'lang_v1.selling_price_group' ); ?>
    </h1>
    <!-- <ol class="breadcrumb">
...
<section class="content">
    ...
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.import_export_selling_price_group_prices')]); ?>
            <div class="row">
                <div class="col-sm-6">
                    <a href="<?php echo e(action('SellingPriceGroupController@export'), false); ?>" class="btn btn-primary"><?php echo app('translator')->getFromJson('lang_v1.export_selling_price_group_prices'); ?></a>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-12">
                    <h4><?php echo app('translator')->getFromJson('lang_v1.instructions'); ?>:</h4>
                    <p>
                        &bull; <?php echo app('translator')->getFromJson('lang_v1.price_group_import_istruction'); ?>
                    </p>
                    <p>
                        &bull; <?php echo app('translator')->getFromJson('lang_v1.price_group_import_istruction1'); ?>
                    </p>
                    <p>
                        &bull; <?php echo app('translator')->getFromJson('lang_v1.price_group_import_istruction2'); ?>
                    </p>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/selling_price_group/index.blade.php ENDPATH**/ ?>