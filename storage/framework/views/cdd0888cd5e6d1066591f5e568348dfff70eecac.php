<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <?php echo Form::open(['url' => action('\Modules\Essentials\Http\Controllers\EssentialsHolidayController@store'), 'method' => 'post', 'id' => 'add_holiday_form' ]); ?>


    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <h4 class="modal-title"><?php echo app('translator')->getFromJson( 'essentials::lang.add_holiday' ); ?></h4>
    </div>
    	...
    	<div class="row">
    		<div class="form-group col-md-12">
	        	<?php echo Form::label('name', __( 'lang_v1.name' ) . ':*'); ?>
	          	...
	          	<?php echo Form::text('name', null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.name' ), 'required']);; ?>
	      	...
	      	<div class="form-group col-md-12">
	        	<?php echo Form::label('location_id', __( 'business.business_location' ) . ':'); ?>
	          	...
	          	<?php echo Form::select('location_id', $locations, null, ['class' => 'form-control select2', 'placeholder' => __( 'lang_v1.all' ) ]);; ?>
...
</div><!-- /.modal-dialog --><?php /**PATH C:\laragon\www\possaas\Modules\Essentials\Providers/../Resources/views/holiday/create.blade.php ENDPATH**/ ?>