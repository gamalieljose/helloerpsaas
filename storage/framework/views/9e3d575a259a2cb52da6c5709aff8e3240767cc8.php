<table class="table table-striped table-th-green text-center" id="ingredients_for_unit_recipe_table">
	<thead>
		<tr>
			...
			<th><?php echo app('translator')->getFromJson('manufacturing::lang.final_quantity'); ?> <?php
                ...
                ?></th>
			<th><?php echo app('translator')->getFromJson('manufacturing::lang.total_price'); ?> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
	...
	<tfoot>
		<tr>
			<td colspan="4" style="text-align: right;"><strong><?php echo app('translator')->getFromJson('manufacturing::lang.ingredients_cost'); ?></strong></td>
...
</table><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Manufacturing/Providers/../Resources/views/recipe/ingredients_for_production.blade.php ENDPATH**/ ?>