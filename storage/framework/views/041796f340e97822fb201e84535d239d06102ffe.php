	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title"><?php echo app('translator')->getFromJson('lang_v1.payment'); ?></h4>
			</div>
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-9">
						...
						<div class="row">
							<div class="col-md-12">
								<button type="button" class="btn btn-primary btn-block" id="add-payment-row"><?php echo app('translator')->getFromJson('sale.add_payment_row'); ?></button>
							</div>
						</div>
						<br>
						<div class="row">
					...
					<div class="col-md-3">
						<div class="box box-solid bg-orange">
				            <div class="box-body">
				            	<div class="col-md-12">
				            		<strong>
				            			<?php echo app('translator')->getFromJson('lang_v1.total_items'); ?>:
				            		</strong>
				            		<br/>
				            	...
				            	<div class="col-md-12">
				            		<hr>
				            		<strong>
				            			<?php echo app('translator')->getFromJson('sale.total_payable'); ?>:
				            		</strong>
				            		<br/>
				            	...
				            	<div class="col-md-12">
				            		<hr>
				            		<strong>
				            			<?php echo app('translator')->getFromJson('lang_v1.total_paying'); ?>:
				            		</strong>
				            		<br/>
				            	...
				            	<div class="col-md-12">
				            		<hr>
				            		<strong>
				            			<?php echo app('translator')->getFromJson('lang_v1.balance'); ?>:
				            		</strong>
				            		<br/>
			...
			<div class="modal-footer">
				...
				<button type="submit" class="btn btn-primary" id="pos-save"><?php echo app('translator')->getFromJson('sale.finalize_payment'); ?></button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="card_details_modal">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title"><?php echo app('translator')->getFromJson('lang_v1.card_transaction_details'); ?></h4>
			</div>
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
		...
		<div class="col-md-3">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id="pos-save-card"><?php echo app('translator')->getFromJson('sale.finalize_payment'); ?></button>
			</div>

		</div>
	</div>
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/sale_pos/partials/payment_modal.blade.php ENDPATH**/ ?>