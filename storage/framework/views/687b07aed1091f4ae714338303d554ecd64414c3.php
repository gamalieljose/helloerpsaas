...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('lang_v1.warranties'); ?>
    </h1>
</section>
        ...
        <table class="table table-bordered table-striped" id="warranty_table">
            <thead>
                <tr>
                    ...
                    <th><?php echo app('translator')->getFromJson( 'lang_v1.duration' ); ?></th>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/warranties/index.blade.php ENDPATH**/ ?>