...
<?php $__env->startSection('content'); ?>
	...
	<section class="content-header">
		<h1>
			<?php echo app('translator')->getFromJson('superadmin::lang.welcome_superadmin'); ?>
		</h1>
	</section>
		...
		<div class="row">
	        <div class="col-lg-4 col-xs-6">
	          ...
	          <div class="small-box bg-aqua">
	            <div class="inner">
	              ...
	              <p><?php echo app('translator')->getFromJson('superadmin::lang.new_subscriptions'); ?></p>
	            </div>
	            <div class="icon">
	              <i class="fa fa-refresh"></i>
	            </div>
	            <a href="<?php echo e(action('\Modules\Superadmin\Http\Controllers\SuperadminSubscriptionsController@index'), false); ?>" class="small-box-footer"><?php echo app('translator')->getFromJson('superadmin::lang.more_info'); ?> <i class="fa fa-arrow-circle-right"></i></a>
	          </div>
	        </div>
	        <!-- ./col -->
	        ...
	        <!-- <div class="col-lg-4 col-xs-6">
	          <div class="small-box bg-green">
	            ...
	            <a href="#" class="small-box-footer"><?php echo app('translator')->getFromJson('superadmin::lang.more_info'); ?><i class="fa fa-arrow-circle-right"></i></a>
	          </div>
	        </div> -->
	        <!-- ./col -->
	        ...
	        <div class="col-lg-4 col-xs-6">
	          ...
	          <div class="small-box bg-yellow">
	            <div class="inner">
	              ...
	              <p><?php echo app('translator')->getFromJson('superadmin::lang.new_registrations'); ?></p>
	            </div>
	            <div class="icon">
	              <i class="ion ion-person-add"></i>
	            </div>
	            <a href="<?php echo e(action('\Modules\Superadmin\Http\Controllers\BusinessController@index'), false); ?>" class="small-box-footer"><?php echo app('translator')->getFromJson('superadmin::lang.more_info'); ?> <i class="fa fa-arrow-circle-right"></i></a>
	          </div>
	        </div>
	        <!-- ./col -->
	        ...
	        <div class="col-lg-4 col-xs-6">
	          ...
	          <div class="small-box bg-red">
	            <div class="inner">
	              ...
	              <p><?php echo app('translator')->getFromJson('superadmin::lang.not_subscribed'); ?></p>
	            </div>
	            <div class="icon">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Superadmin/Providers/../Resources/views/superadmin/index.blade.php ENDPATH**/ ?>