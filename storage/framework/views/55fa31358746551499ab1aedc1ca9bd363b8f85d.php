...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-4">
                <h3><?php echo app('translator')->getFromJson( 'lang_v1.view_user' ); ?></h3>
            </div>
            ...
            <div class="col-md-3">
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        ...
                        <p class="text-muted text-center" title="<?php echo app('translator')->getFromJson('user.role'); ?>">
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b><?php echo app('translator')->getFromJson( 'business.username' ); ?></b>
                                <a class="pull-right"><?php echo e($user->username, false); ?></a>
                            </li>
                            <li class="list-group-item">
                                <b><?php echo app('translator')->getFromJson( 'business.email' ); ?></b>
                            ...
                            <li class="list-group-item">
                                ...
                                <?php if($user->status == 'active'): ?>
                                    <span class="label label-success pull-right">
                                        <?php echo app('translator')->getFromJson('business.is_active'); ?>
                                    </span>
                                <?php else: ?>
                                    <span class="label label-danger pull-right">
                                        <?php echo app('translator')->getFromJson('lang_v1.inactive'); ?>
                                    </span>
                                <?php endif; ?>
                            </li>
                        </ul>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php endif; ?>
                                        <p>
                                            <strong><?php echo app('translator')->getFromJson( 'lang_v1.allowed_contacts' ); ?>: </strong>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/manage_user/show.blade.php ENDPATH**/ ?>