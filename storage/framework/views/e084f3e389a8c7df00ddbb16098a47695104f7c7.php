      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <?php echo Form::label('time', __('restaurant.start_time') . ':*'); ?>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <?php echo Form::label('time', __('restaurant.end_time') . ':'); ?>

                      <div class='input-group'>
                        <span class="input-group-addon">
                              <span class="glyphicon glyphicon-time"></span>
                          </span>
                <?php echo Form::text('end_time', \Carbon::createFromTimestamp(strtotime('now'))->format('H:i'), ['class' => 'form-control', 'id' => 'end_time', 'readonly']);; ?>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Essentials/Providers/../Resources/views/reminder/create.blade.php ENDPATH**/ ?>