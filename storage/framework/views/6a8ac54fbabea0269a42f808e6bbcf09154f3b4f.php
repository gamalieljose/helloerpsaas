      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            <br>
            <label>
              <?php echo Form::checkbox('applicable_in_cg', 1, false, ['class' => 'input-icheck']);; ?> <strong><?php echo app('translator')->getFromJson('lang_v1.applicable_in_cg'); ?></strong>
            </label>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            <label>
              <?php echo Form::checkbox('is_active', 1, true, ['class' => 'input-icheck']);; ?> <strong><?php echo app('translator')->getFromJson('lang_v1.is_active'); ?></strong>
            </label>
          </div>
        </div>
...
</div><!-- /.modal-dialog --><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/discount/create.blade.php ENDPATH**/ ?>