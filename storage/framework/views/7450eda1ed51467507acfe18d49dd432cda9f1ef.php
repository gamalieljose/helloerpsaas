	...
	<div class="col-sm-12">
		...
		<div class="box box-solid">
			<div class="box-header">
	            <h3 class="box-title"><?php echo app('translator')->getFromJson('sale.location'); ?>: <?php echo e($value, false); ?></h3>
	        </div>
			<div class="box-body">
				<div class="row">
					<div class="col-sm-12">
						<table class="table table-condensed table-bordered table-th-green text-center table-striped add_opening_stock_table">
								...
								<tr>
									...
									<?php endif; ?>
									<th><?php echo app('translator')->getFromJson( 'purchase.subtotal_before_tax' ); ?></th>
									<th>&nbsp;</th>
								</tr>
								</thead>
								<tbody>
...
<?php endif; ?>
	...
	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								...
								<tr>
									...
									<td><strong><?php echo app('translator')->getFromJson( 'lang_v1.total_amount_exc_tax' ); ?>: </strong> <span id="total_subtotal"><?php echo e(number_format($subtotal, config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?></span>
		...
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    		<h3><?php echo app('translator')->getFromJson( 'lang_v1.product_not_assigned_to_any_location' ); ?></h3>
		<?php endif; ?>
	</div>
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/opening_stock/form-part.blade.php ENDPATH**/ ?>