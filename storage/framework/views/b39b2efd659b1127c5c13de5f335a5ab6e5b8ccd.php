	...
	<div class="modal-content">
	    ...
	    <div class="modal-body">
	    	<div class="row">
      		...
      		<div class="row">
      			<div class="col-md-12">
      				<table class="table">
							...
							<?php $__currentLoopData = $ingredients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ingredient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								<?php if(empty($ingredient['mfg_ingredient_group_id'])): ?>
									<tr>
										...
										<td><span class="display_currency" data-currency_symbol="false"><?php echo e($ingredient['quantity'], false); ?></span> <?php echo e($ingredient['unit'], false); ?></td>
						...
						<tfoot>
							<tr>
								<td colspan="3" class="text-right"><strong><?php echo app('translator')->getFromJson('manufacturing::lang.ingredients_cost'); ?></strong></td>
      		...
      		<div class="row">
      			<div class="col-md-6">
      				<strong><?php echo app('translator')->getFromJson('manufacturing::lang.wastage'); ?>:</strong>
      				<?php echo e($recipe->waste_percent ?? 0, false); ?> % <br>
      				<strong><?php echo app('translator')->getFromJson('manufacturing::lang.total_output_quantity'); ?>:</strong>
      				<?php if(!empty($recipe->total_quantity)): ?><?php echo e(number_format($recipe->total_quantity, config('constants.quantity_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?><?php else: ?> 0 <?php endif; ?> <?php if(!empty($recipe->sub_unit)): ?> <?php echo e($recipe->sub_unit->short_name, false); ?> <?php else: ?> <?php echo e($recipe->variation->product->unit->short_name, false); ?> <?php endif; ?>
      			</div>
      			<div class="col-md-6">
      				<strong><?php echo app('translator')->getFromJson('manufacturing::lang.extra_cost'); ?>:</strong>
      				<span ></span><?php echo e(number_format($recipe->extra_cost, config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?> <?php if($recipe->production_cost_type == 'percentage'): ?> % <?php elseif($recipe->production_cost_type == 'per_unit'): ?> (<?php echo app('translator')->getFromJson('manufacturing::lang.per_unit'); ?>) <?php endif; ?> <br>
      				<?php
      				...
      				<span class="display_currency" data-currency_symbol="true"><?php echo e($final_price, false); ?></span>
      			</div>
      		</div>
      		<div class="row">
      			<div class="col-md-12">
      				<strong><?php echo app('translator')->getFromJson('lang_v1.instructions'); ?>:</strong><br>
...
<?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Manufacturing/Providers/../Resources/views/recipe/show.blade.php ENDPATH**/ ?>