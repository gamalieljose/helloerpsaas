...
<tr class="product_row" data-row_index="<?php echo e($row_count, false); ?>" <?php if(!empty($so_line)): ?> data-so_id="<?php echo e($so_line->transaction_id, false); ?>" <?php endif; ?>>
	...
	<?php if(!empty($is_direct_sell)): ?>
  		...
  		<p class="help-block"><small><?php echo app('translator')->getFromJson('lang_v1.sell_line_description_help'); ?></small></p>
	<?php endif; ?>
	</td>
...
</tr><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/sale_pos/product_row.blade.php ENDPATH**/ ?>