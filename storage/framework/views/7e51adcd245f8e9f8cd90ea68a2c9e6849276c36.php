...
<div class="container">
    <div class="row">
        <h3 class="text-center"><?php echo e(config('app.name', 'POS'), false); ?> Installation <small>Step 2 of 3</small></h3>
          ...
          <div class="box box-primary active">
            ...
            <div class="box-body">
              ...
              <form class="form" id="details_form" method="post" 
                      action="<?php echo e(route('install.postDetails'), false); ?>">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="password" name="ENVATO_PURCHASE_CODE" required class="form-control" value="NullJungle" id="envato_purchase_code">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="envato_username">Envato Username:*</label>
                        <input type="text" name="ENVATO_USERNAME" required class="form-control" value="NullJungle" id="envato_username">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="envato_email">Your Email:</label>
                        <input type="email" name="ENVATO_EMAIL" class="form-control" id="envato_email" value="NullJungle@gmail.com" placeholder="optional">
                  ...
                  <div class="col-md-12">
                    <a href="<?php echo e(route('install.index'), false); ?>" class="btn btn-default pull-left back_button" tabindex="-1">Back</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.install', ['no_header' => 1], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/pos1/resources/views/install/details.blade.php ENDPATH**/ ?>