...
<section class="content-header">
    <h1>
        <?php echo app('translator')->getFromJson('report.reports'); ?>
        <small>
            <?php echo app('translator')->getFromJson('project::lang.time_logs'); ?> <?php echo app('translator')->getFromJson('project::lang.by_employees'); ?>
        </small>
    </h1>
</section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Project/Providers/../Resources/views/reports/employee_timelog.blade.php ENDPATH**/ ?>