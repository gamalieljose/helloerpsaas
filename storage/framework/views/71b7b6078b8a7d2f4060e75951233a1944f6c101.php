<div class="row" id="quick_product_opening_stock_div">
	<div class="col-sm-12">
		<h4><?php echo app('translator')->getFromJson('lang_v1.add_opening_stock'); ?></h4>
	</div>
	<div class="col-sm-12">
		<table class="table table-condensed table-th-green" id="quick_product_opening_stock_table">
			...
			<tr>
				...
				<?php if($enable_expiry): ?>
					<th><?php echo app('translator')->getFromJson('lang_v1.expiry_date'); ?></th>
				<?php endif; ?>
				<?php if($enable_lot): ?>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/product/partials/quick_product_opening_stock.blade.php ENDPATH**/ ?>