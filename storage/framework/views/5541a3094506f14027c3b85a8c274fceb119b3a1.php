...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson( 'unit.units' ); ?>
        <small><?php echo app('translator')->getFromJson( 'unit.manage_your_units' ); ?></small>
    </h1>
    <!-- <ol class="breadcrumb">
                ...
                <table class="table table-bordered table-striped" id="unit_table">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo app('translator')->getFromJson( 'unit.short_name' ); ?></th>
                            <th><?php echo app('translator')->getFromJson( 'unit.allow_decimal' ); ?> <?php
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/unit/index.blade.php ENDPATH**/ ?>