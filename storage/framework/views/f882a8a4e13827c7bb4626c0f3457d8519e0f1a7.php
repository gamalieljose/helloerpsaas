...
<?php echo $__env->make('essentials::layouts.nav_essentials', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	...
	<h4>
		<?php echo app('translator')->getFromJson('essentials::lang.all_documents'); ?>
		<small> <?php echo app('translator')->getFromJson('essentials::lang.manage_document'); ?></small>
	</h4>
		<div class="box box-solid">
			<div class="box-header">
				<h4 class="box-title"><?php echo app('translator')->getFromJson('essentials::lang.all_documents'); ?></h4>
					...
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-bordered table-striped documents">
								<thead>
									<tr>
										<th> <?php echo app('translator')->getFromJson('essentials::lang.name'); ?></th>
										<th> <?php echo app('translator')->getFromJson('essentials::lang.description'); ?></th>
										<th> <?php echo app('translator')->getFromJson('essentials::lang.uploaded_date'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Essentials/Providers/../Resources/views/document/index.blade.php ENDPATH**/ ?>