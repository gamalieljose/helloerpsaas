...
<br>
    <h1><?php echo app('translator')->getFromJson('lang_v1.add_purchase_return'); ?></h1>
</section>
...
<section class="content no-print">
	...
	<div class="box box-solid">
		...
		<div class="box-body">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="pull-right"><b><?php echo app('translator')->getFromJson('stock_adjustment.total_amount'); ?>:</b> <span id="total_return">0.00</span></div>
				</div>
			</div>
		</div>
	</div> <!--box end-->
	<div class="row">
		<div class="col-md-12">
			<button type="button" id="submit_purchase_return_form" class="btn btn-primary pull-right btn-flat"><?php echo app('translator')->getFromJson('messages.submit'); ?></button>
		</div>
	</div>
	<?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/purchase_return/create.blade.php ENDPATH**/ ?>