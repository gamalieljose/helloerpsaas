                ...
                <table class="table table-bordered table-striped" id="register_report_table">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo app('translator')->getFromJson('lang_v1.total_bank_transfer'); ?></th>
                            <th><?php echo app('translator')->getFromJson('lang_v1.total_advance_payment'); ?></th>
                            ...
                            <th><?php echo app('translator')->getFromJson('cash_register.other_payments'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/report/register_report.blade.php ENDPATH**/ ?>