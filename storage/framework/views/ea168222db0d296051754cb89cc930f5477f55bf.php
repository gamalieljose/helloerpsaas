...
<?php $__env->startSection('content'); ?>
	...
	<section class="content-header no-print">
	   <h1><?php echo app('translator')->getFromJson('crm::lang.follow_ups'); ?></h1>
	</section>
	        ...
	        <div class="row">
	            ...
	            <?php if(auth()->user()->can('crm.access_all_schedule')): ?>
		            <div class="col-md-4">
		                <div class="form-group">
		                    ...
		                    <?php echo Form::select('assgined_to_filter', $assigned_to, null, ['class' => 'form-control select2', 'id' => 'assgined_to_filter', 'placeholder' => __('messages.all')]);; ?>
	            ...
	            <div class="col-md-4">
	                <div class="form-group">
	                    ...
	                    <?php echo Form::select('status_filter', $statuses, null, ['class' => 'form-control select2', 'id' => 'status_filter', 'placeholder' => __('messages.all')]);; ?>
				...
				<?php $__env->startComponent('components.widget', ['class' => 'box box-solid', 'title' => __('crm::lang.all_schedules')]); ?>
					<?php $__env->slot('tool'); ?>
			            <div class="box-tools">
			                ...
			                <i class="fa fa-plus"></i> <?php echo app('translator')->getFromJson('crm::lang.add_advance_follow_up'); ?></button>
			            </div>
			            <input type="hidden" name="schedule_create_url" id="schedule_create_url" value="<?php echo e(action('\Modules\Crm\Http\Controllers\ScheduleController@create'), false); ?>">
		        	<?php $__env->endSlot(); ?>
			        <div class="col-sm-12">
			        	<div class="nav-tabs-custom">
			                <ul class="nav nav-tabs">
			                    <li class="active">
			                        <a href="#all_followup_tab" data-toggle="tab" aria-expanded="true"> <?php echo app('translator')->getFromJson('crm::lang.follow_ups'); ?></a>
			                    </li>
			                    <li>
			                        <a href="#recur_followup_tab" data-toggle="tab" aria-expanded="true"> <?php echo app('translator')->getFromJson('crm::lang.recur_follow_ups'); ?></a>
			                    </li>
			                </ul>
						            	...
						            	<table class="table table-bordered table-striped" id="follow_up_table" style="width: 100%">
									        <thead>
									            <tr>
									            	...
									            	<th>
									            		<?php echo app('translator')->getFromJson('contact.contact'); ?>
									            	</th>
									            	<th><?php echo app('translator')->getFromJson('crm::lang.start_datetime'); ?></th>
									                <th><?php echo app('translator')->getFromJson('crm::lang.end_datetime'); ?></th>
									                <th><?php echo app('translator')->getFromJson('sale.status'); ?></th>
									                <th><?php echo app('translator')->getFromJson('crm::lang.schedule_type'); ?></th>
									                <th><?php echo app('translator')->getFromJson('lang_v1.assigned_to'); ?></th>
									                <th>
									                	<?php echo app('translator')->getFromJson('crm::lang.description'); ?>
									                </th>
									                <th>
									                	<?php echo app('translator')->getFromJson('crm::lang.additional_info'); ?>
									                </th>
									                <th><?php echo app('translator')->getFromJson('crm::lang.title'); ?></th>
									                <th>
									                	<?php echo app('translator')->getFromJson('lang_v1.added_by'); ?>
									                </th>
									                <th>
									                	<?php echo app('translator')->getFromJson('lang_v1.added_on'); ?>
									                </th>
									            </tr>
									        </thead>
									        <tbody></tbody>
									        <tfoot>
			                                    <tr class="bg-gray font-17 footer-total text-center">
			                                        <td colspan="4">
			                                            <strong><?php echo app('translator')->getFromJson('sale.total'); ?>:</strong>
			                                        </td>
						            	...
						            	<table class="table table-bordered table-striped" id="recursive_follow_up_table" style="width: 100%">
									        <thead>
									            <tr>
									                ...
									                <th><?php echo app('translator')->getFromJson('sale.status'); ?></th>
									                <th><?php echo app('translator')->getFromJson('crm::lang.schedule_type'); ?></th>
									                <th><?php echo app('translator')->getFromJson('crm::lang.follow_up_by'); ?></th>
									                <th><?php echo app('translator')->getFromJson('crm::lang.in_days'); ?></th>
									                <th><?php echo app('translator')->getFromJson('lang_v1.assigned_to'); ?></th>
									                <th>
									                	<?php echo app('translator')->getFromJson('crm::lang.description'); ?>
									                </th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Crm/Providers/../Resources/views/schedule/index.blade.php ENDPATH**/ ?>