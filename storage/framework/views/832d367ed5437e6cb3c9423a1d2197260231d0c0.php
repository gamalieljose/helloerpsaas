...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson('invoice.add_invoice_layout'); ?></h1>
</section>
...
<?php echo Form::open(['url' => action('InvoiceLayoutController@store'), 'method' => 'post', 'id' => 'add_invoice_layout_form', 'files' => true]); ?>
      ...
      <div class="row">
          ...
          <div class="form-group">
            <?php echo Form::label('design', __('lang_v1.design') . ':*'); ?>
              ...
              <span class="help-block">
                <?php echo app('translator')->getFromJson('lang_v1.used_for_browser_based_printing'); ?>
              </span>
          </div>
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <span class="help-block"><?php echo app('translator')->getFromJson('lang_v1.invoice_logo_help', ['max_size' => '1 MB']); ?></span>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_logo', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('invoice.show_logo'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-12">
    ...
    <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <?php
                ...
                ?>
            <?php echo Form::text('common_settings[proforma_heading]', __('lang_v1.proforma_invoice'), ['class' => 'form-control',
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('common_settings[show_due_date]', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_due_date'); ?></label>
              </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <?php echo Form::text('commission_agent_label', __('lang_v1.commission_agent'), ['class' => 'form-control',
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_business_name', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('invoice.show_business_name'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_location_name', 1, true, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('invoice.show_location_name'); ?></label>
              </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_sales_person', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_sales_person'); ?></label>
              </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_commission_agent', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_commission_agent'); ?></label>
              </div>
          </div>
        </div>
        <div class="clearfix"></div>
        <div class="col-sm-12">
          <h4><?php echo app('translator')->getFromJson('lang_v1.fields_for_customer_details'); ?>:</h4>
        </div>
        <div class="clearfix"></div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_customer', 1, true, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('invoice.show_customer'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_client_id', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_client_id'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_reward_point', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_reward_point'); ?></label>
              </div>
          </div>
        </div>
        <div class="clearfix"></div>
      ...
      <div class="col-sm-3">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_landmark', 1, true, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('business.landmark'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_city', 1, true, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('business.city'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_state', 1, true, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('business.state'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_country', 1, true, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('business.country'); ?></label>
              </div>
          </div>
        </div>
        <div class="clearfix"></div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_zip_code', 1, true, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('business.zip_code'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
      ...
      <div class="col-sm-3">
        ...
        <div class="col-sm-12">
          <h4><?php echo app('translator')->getFromJson('invoice.fields_to_shown_for_communication'); ?>:</h4>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_mobile_number', 1, true, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('invoice.show_mobile_number'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_alternate_number', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('invoice.show_alternate_number'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_email', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('invoice.show_email'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-12">
          <h4><?php echo app('translator')->getFromJson('invoice.fields_to_shown_for_tax'); ?>:</h4>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_tax_1', 1, true, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('invoice.show_tax_1'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_tax_2', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('invoice.show_tax_2'); ?></label>
              </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <?php echo Form::text('common_settings[item_discount_label]', 'Discount', ['class' => 'form-control',
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_brand', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_brand'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_sku', 1, true, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_sku'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_cat_code', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_cat_code'); ?></label>
              </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_sale_description', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_sale_description'); ?></label>
            </div>
      ...
      <div class="clearfix"></div>
        <?php if(request()->session()->get('business.enable_product_expiry') == 1): ?>
          <div class="col-sm-3">
            <div class="form-group">
              <div class="checkbox">
                <label>
                  <?php echo Form::checkbox('show_expiry', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_product_expiry'); ?></label>
                </div>
            </div>
          </div>
        <?php endif; ?>
        <?php if(request()->session()->get('business.enable_lot_number') == 1): ?>
          <div class="col-sm-3">
            <div class="form-group">
              <div class="checkbox">
                <label>
                  <?php echo Form::checkbox('show_lot', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_lot_number'); ?></label>
                </div>
            </div>
          </div>
        <?php endif; ?>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_image', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_product_image'); ?></label>
              </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('common_settings[show_warranty_name]', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_warranty_name'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('common_settings[show_warranty_exp_date]', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_warranty_exp_date'); ?></label>
              </div>
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('common_settings[show_warranty_description]', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_warranty_description'); ?></label>
              </div>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_payments', 1, true, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('invoice.show_payments'); ?></label>
              </div>
          </div>
        </div>
        <!-- Barcode -->
        <div class="col-sm-3">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_barcode', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('invoice.show_barcode'); ?></label>
              </div>
          </div>
        </div>
        <div class="clearfix"></div>
        ...
        <div class="col-sm-5">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('show_previous_bal', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_previous_bal_due'); ?></label>
                <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
        ...
        <div class="col-sm-3 hide" id="hide_price_div">
          <div class="form-group">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('common_settings[hide_price]', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.hide_all_prices'); ?></label>
              </div>
          </div>
        </div>
        ...
        <div class="col-sm-3">
          <div class="form-group">
              <label>
                <?php echo Form::checkbox('common_settings[show_total_in_words]', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_total_in_words'); ?></label> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                ...
                <?php if(!extension_loaded('intl')): ?>
                  <p class="help-block"><?php echo app('translator')->getFromJson('lang_v1.enable_php_intl_extension'); ?></p>
                <?php endif; ?>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('is_default', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('barcode.set_as_default'); ?></label>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox">
          <label>
            <?php echo Form::checkbox('show_qr_code', 1, false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.show_qr_code'); ?></label>
        </div>
      </div>
    </div>
    <div class="clearfix"></div>
    <div class="col-md-12">
      <h4><?php echo app('translator')->getFromJson('lang_v1.fields_to_be_shown'); ?>:</h4>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox">
          <label>
            <?php echo Form::checkbox('qr_code_fields[]', 'business_name', false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('business.business_name'); ?></label>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox">
          <label>
            <?php echo Form::checkbox('qr_code_fields[]', 'address', false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.business_location_address'); ?></label>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox">
          <label>
            <?php echo Form::checkbox('qr_code_fields[]', 'tax_1', false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.business_tax_1'); ?></label>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox">
          <label>
            <?php echo Form::checkbox('qr_code_fields[]', 'tax_2', false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.business_tax_2'); ?></label>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox">
          <label>
            <?php echo Form::checkbox('qr_code_fields[]', 'invoice_no', false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('sale.invoice_no'); ?></label>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox">
          <label>
            <?php echo Form::checkbox('qr_code_fields[]', 'invoice_datetime', false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.invoice_datetime'); ?></label>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox">
          <label>
            <?php echo Form::checkbox('qr_code_fields[]', 'subtotal', false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('sale.subtotal'); ?></label>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox">
          <label>
            <?php echo Form::checkbox('qr_code_fields[]', 'total_amount', false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.total_amount_with_tax'); ?></label>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox">
          <label>
            <?php echo Form::checkbox('qr_code_fields[]', 'total_tax', false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.total_tax'); ?></label>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox">
          <label>
            <?php echo Form::checkbox('qr_code_fields[]', 'customer_name', false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('sale.customer_name'); ?></label>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
        <div class="checkbox">
          <label>
            <?php echo Form::checkbox('qr_code_fields[]', 'invoice_url', false, ['class' => 'input-icheck']);; ?> <?php echo app('translator')->getFromJson('lang_v1.view_invoice_url'); ?></label>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-sm-12 text-center">
      <button type="submit" class="btn btn-primary btn-big"><?php echo app('translator')->getFromJson('messages.save'); ?></button>
    </div>
  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/invoice_layout/create.blade.php ENDPATH**/ ?>