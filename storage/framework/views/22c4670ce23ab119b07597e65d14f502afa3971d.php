...
<div class="row">
	<div class="col-md-12">
		<hr>
		<button type="button" class="btn btn-primary more_btn" data-target="#add_contact_person_div_<?php echo e($index, false); ?>"><?php echo app('translator')->getFromJson('crm::lang.add_contact_person', ['number' => $index + 1]); ?> <i class="fa fa-chevron-down"></i></button>
	</div>
</div>
<br>
<div class="row <?php if($index !== 0): ?>hide <?php endif; ?>" id="add_contact_person_div_<?php echo e($index, false); ?>">
	...
	<div class="col-md-6">
		<div class="form-group">
		    <?php echo Form::label("department$index", __( 'lang_v1.department' ) . ':'); ?>

		    <?php echo Form::text($index === '' ? 'crm_department' : "contact_persons[$index][crm_department]", !empty($user->crm_department) ? $user->crm_department : null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.department'), 'id'=>"department$index" ]);; ?>

		</div>
	</div>
	<div class="col-md-6">
		<div class="form-group">
		    <?php echo Form::label("designation$index", __( 'lang_v1.designation' ) . ':'); ?>

		    <?php echo Form::text($index === '' ? 'crm_designation' : "contact_persons[$index][crm_designation]", !empty($user->crm_designation) ? $user->crm_designation : null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.designation'), 'id'=>"designation$index" ]);; ?>
...
</div><?php /**PATH C:\laragon\www\helloerp\Modules\Crm\Providers/../Resources/views/contact_login/partial/contact_login_from.blade.php ENDPATH**/ ?>