			...
			<table class="table table-bordered table-striped" id="task_table">
				<thead>
					<tr>
						...
						<th> <?php echo app('translator')->getFromJson('essentials::lang.task_id'); ?></th>
						<th class="col-md-2"> <?php echo app('translator')->getFromJson('essentials::lang.task'); ?></th>
						...
						<th> <?php echo app('translator')->getFromJson('essentials::lang.estimated_hours'); ?></th>
						<th> <?php echo app('translator')->getFromJson('essentials::lang.assigned_by'); ?></th>
						<th> <?php echo app('translator')->getFromJson('essentials::lang.assigned_to'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Essentials/Providers/../Resources/views/todo/index.blade.php ENDPATH**/ ?>