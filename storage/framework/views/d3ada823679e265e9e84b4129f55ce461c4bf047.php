		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="row <?php if(!$is_rp_enabled): ?> hide <?php endif; ?>">
				    ...
				    <div class="col-md-6">
				    	<p><strong><?php echo app('translator')->getFromJson('lang_v1.available'); ?>:</strong> <span id="available_rp"><?php echo e($max_available, false); ?></span></p>
				    	<h5><strong><?php echo app('translator')->getFromJson('lang_v1.redeemed_amount'); ?>:</strong> <span id="rp_redeemed_amount_text"><?php echo e(number_format($rp_redeemed_amount, config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?></span></h5>
				    </div>
				    </div>
				</div>
			</div>
...
</div><!-- /.modal --><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/sale_pos/partials/edit_discount_modal.blade.php ENDPATH**/ ?>