...
<section class="content-header no-print">
    <h1><?php echo app('translator')->getFromJson('repair::lang.invoices'); ?>
    </h1>
</section>
        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                            ...
                            <table class="table table-bordered table-striped ajax_view" id="pending_repair_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <?php echo app('translator')->getFromJson('repair::lang.delivery_date'); ?>
                                            <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                ...
                ?>
                                        ...
                                        <th><?php echo app('translator')->getFromJson('repair::lang.repair_warranty'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Repair/Providers/../Resources/views/repair/index.blade.php ENDPATH**/ ?>