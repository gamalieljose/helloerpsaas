    ...
    <div class="row">
        <div class="col-xs-6">
            <div class="form-group">
                ...
                <?php echo app('translator')->getFromJson('superadmin::lang.allow_registration'); ?>
                </label>
            </div>
        </div>
        <div class="col-xs-6">
            <div class="form-group">
                ...
                <?php echo app('translator')->getFromJson('superadmin::lang.enable_register_tc'); ?>
                </label>
            </div>
        </div>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Superadmin/Providers/../Resources/views/superadmin_settings/partials/application_settings.blade.php ENDPATH**/ ?>