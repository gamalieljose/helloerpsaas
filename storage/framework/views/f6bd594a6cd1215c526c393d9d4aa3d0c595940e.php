...
<div class="row">
	<div class="col-xs-12">
		...
		<table class="table table-responsive table-slim">
			<thead>
				<tr>
					<th width="40%"><?php echo e($receipt_details->table_product_label, false); ?></th>
					<th class="text-right" width="20%"><?php echo e($receipt_details->table_qty_label, false); ?></th>
					
					<th colspan="2" class="text-right" width="20%"><?php echo e($receipt_details->table_subtotal_label, false); ?></th>
				</tr>
			</thead>
			<tbody>
				<?php
				...
				?>
				<?php if(count($receipt_details->lines) > 0): ?>
					<tr>
						<th>
							<?php echo app('translator')->getFromJson('repair::lang.repair_charges'); ?>
						</th>
						<td class="text-right">
							<?php echo e(number_format('1', config('constants.quantity_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?>

						</td>
						<td class="text-right" colspan="2">
							<?php if(session("business.currency_symbol_placement") == "before"): ?>
								<?php echo e(session("currency")["symbol"], false); ?>

							<?php endif; ?>
							<?php echo e(number_format($total_line_total, config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?>

							<?php if(session("business.currency_symbol_placement") == "after"): ?>
								<?php echo e(session("currency")["symbol"], false); ?>
...
<?php endif; ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Repair/Providers/../Resources/views/repair/receipts/classic.blade.php ENDPATH**/ ?>