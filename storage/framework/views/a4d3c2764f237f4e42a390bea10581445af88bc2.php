			    			...
			    			<table class="table table-striped">
			    				<thead>
			    					<tr>
			    						...
			    						<th>
			    							<?php echo app('translator')->getFromJson('project::lang.start_date_time'); ?>
			    						</th>
			    						<th>
			    							<?php echo app('translator')->getFromJson('project::lang.end_date_time'); ?>
			    						</th>
			    						<th><?php echo app('translator')->getFromJson('project::lang.work_hour'); ?></th>
			    						<th>
			    							<?php echo app('translator')->getFromJson('brand.note'); ?>
			    						</th>
			    					</tr>
			    				</thead>
			    				<tbody>
...
<?php if($record_not_available): ?>
	<div class="callout callout-info">
        <h4>
        	...
        	<?php echo app('translator')->getFromJson('project::lang.no_record_found'); ?>
        </h4>
    </div>
<?php endif; ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Project/Providers/../Resources/views/reports/partials/employee_timelog.blade.php ENDPATH**/ ?>