        ...
        <?php if( $contact->type == 'supplier' || $contact->type == 'both'): ?>
            ...
            <div class="col-sm-12">
                <?php if(($contact->total_purchase - $contact->purchase_paid) > 0): ?>
                    <a href="<?php echo e(action('TransactionPaymentController@getPayContactDue', [$contact->id]), false); ?>?type=purchase" class="pay_purchase_due btn btn-primary btn-sm pull-right"><i class="fas fa-money-bill-alt" aria-hidden="true"></i> <?php echo app('translator')->getFromJson("contact.pay_due_amount"); ?></a>
                <?php endif; ?>
            </div>
        <?php endif; ?>
    </div>
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/contact/partials/contact_info_tab.blade.php ENDPATH**/ ?>