<tr>
    ...
    <td <?php if($count_child_payments > 0): ?> class="bg-gray" <?php endif; ?>>
        ...
        <?php if(!empty($parent_payment_ref_no)): ?>
            <br><?php echo app('translator')->getFromJson('lang_v1.parent_payment'); ?>: <?php echo e($parent_payment_ref_no, false); ?>
...
</tr><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/contact/partials/payment_row.blade.php ENDPATH**/ ?>