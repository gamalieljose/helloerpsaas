...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson( 'manufacturing::lang.manufacturing_report' ); ?>
    </h1>
</section>

<!-- Main content -->
<section class="content">
    <div class="print_section"><h2><?php echo e(session()->get('business.name'), false); ?> - <?php echo app('translator')->getFromJson( 'manufacturing::lang.manufacturing_report' ); ?></h2></div>
    ...
    <div class="row no-print">
        <div class="col-md-3">
            <a href="<?php echo e(action('ReportController@getStockReport'), false); ?>?only_mfg=true" class="btn btn-info btn-flat btn-block"><?php echo app('translator')->getFromJson('report.stock_report'); ?></a>
        </div>
        <?php if(session('business.enable_lot_number') == 1): ?>
        <div class="col-md-3">
            <a href="<?php echo e(action('ReportController@getLotReport'), false); ?>?only_mfg=true" class="btn btn-success btn-flat btn-block"><?php echo app('translator')->getFromJson('lang_v1.lot_report'); ?></a>
        </div>
        <?php endif; ?>
        <?php if(session('business.enable_product_expiry') == 1): ?>
        <div class="col-md-3">
            <a href="<?php echo e(action('ReportController@getStockExpiryReport'), false); ?>?only_mfg=true" class="btn btn-warning btn-flat btn-block"><?php echo app('translator')->getFromJson('report.stock_expiry_report'); ?></a>
        </div>
        <?php endif; ?>
        <div class="col-md-3">
            <a href="<?php echo e(action('ReportController@itemsReport'), false); ?>?only_mfg=true" class="btn btn-danger btn-flat btn-block"><?php echo app('translator')->getFromJson('lang_v1.items_report'); ?></a>
        </div>
    </div>
    <br>
    <div class="row no-print">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Manufacturing/Providers/../Resources/views/production/report.blade.php ENDPATH**/ ?>