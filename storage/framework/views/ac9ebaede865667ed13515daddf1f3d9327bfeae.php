    ...
    <div class="modal-content">
        ...
        <?php echo Form::open(['url' => action('\Modules\Manufacturing\Http\Controllers\RecipeController@addIngredients'), 'method' => 'get', 'id' => 'choose_product_form']); ?>
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo app('translator')->getFromJson( 'manufacturing::lang.choose_product' ); ?></h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-primary"><?php echo app('translator')->getFromJson( 'manufacturing::lang.continue' ); ?></button>
            </div>
...
</div><!-- /.modal-dialog --><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Manufacturing/Providers/../Resources/views/recipe/create.blade.php ENDPATH**/ ?>