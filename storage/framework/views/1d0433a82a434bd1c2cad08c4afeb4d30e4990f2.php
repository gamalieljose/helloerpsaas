                ...
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#pending_job_sheet_tab" data-toggle="tab" aria-expanded="true">
                            ...
                            <?php echo app('translator')->getFromJson('repair::lang.pending'); ?>
                            <?php
                ...
                ?>
                    ...
                    <li>
                        <a href="#completed_job_sheet_tab" data-toggle="tab" aria-expanded="true">
                            ...
                            <?php echo app('translator')->getFromJson('repair::lang.completed'); ?>
                            <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
                            ...
                            <table class="table table-bordered table-striped" id="pending_job_sheets_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <?php echo app('translator')->getFromJson('repair::lang.service_type'); ?>
                                        </th>
                                        <th>
                                        ...
                                        <?php if(in_array('service_staff' ,$enabled_modules)): ?>
                                            <th><?php echo app('translator')->getFromJson('repair::lang.technician'); ?></th>
                                        <?php endif; ?>
                                        <th>
                                        ...
                                        <th><?php echo app('translator')->getFromJson('repair::lang.estimated_cost'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Repair/Providers/../Resources/views/job_sheet/index.blade.php ENDPATH**/ ?>