...
<section class="content-header no-print">
   <h1><?php echo app('translator')->getFromJson('crm::lang.leads'); ?></h1>
</section>
            ...
            <div class="box-tools">
                ...
                <div class="btn-group btn-group-toggle pull-right m-5" data-toggle="buttons">
                    <label class="btn btn-info btn-sm active list">
                        ...
                        <?php echo app('translator')->getFromJson('crm::lang.list_view'); ?>
                    </label>
                    <label class="btn btn-info btn-sm kanban">
                        ...
                        <?php echo app('translator')->getFromJson('crm::lang.kanban_board'); ?>
                    </label>
                </div>
            </div>
        <?php $__env->endSlot(); ?>
        	...
        	<table class="table table-bordered table-striped" id="leads_table">
		        <thead>
		            <tr>
                        ...
                        <th><?php echo app('translator')->getFromJson('crm::lang.source'); ?></th>
                        <th style="width: 200px !important">
                            <?php echo app('translator')->getFromJson('crm::lang.last_follow_up'); ?>
                        </th>
                        <th style="width: 200px !important">
                            <?php echo app('translator')->getFromJson('crm::lang.upcoming_follow_up'); ?>
                        </th>
                        <th><?php echo app('translator')->getFromJson('crm::lang.life_stage'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Crm/Providers/../Resources/views/lead/index.blade.php ENDPATH**/ ?>