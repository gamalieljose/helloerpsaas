    ...
    <tr <?php if(!empty($purchase_order_line)): ?> data-purchase_order_id="<?php echo e($purchase_order_line->transaction_id, false); ?>" <?php endif; ?>>
        ...
        <td>
            ...
            <?php if($product->enable_stock == 1): ?>
                <br>
                <small class="text-muted" style="white-space: nowrap;"><?php echo app('translator')->getFromJson('report.current_stock'); ?>: <?php if(!empty($variation->variation_location_details->first())): ?> <?php echo e(number_format($variation->variation_location_details->first()->qty_available, config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?> <?php else: ?> 0 <?php endif; ?> <?php echo e($product->unit->short_name, false); ?></small>
            <?php endif; ?>
        ...
        <td>
            ...
            <input type="text" 
                ...
                value="<?php echo e(number_format($quantity_value, config('constants.quantity_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?>"
...
<input type="hidden" id="row_count" value="<?php echo e($row_count, false); ?>"><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/purchase/partials/purchase_entry_row.blade.php ENDPATH**/ ?>