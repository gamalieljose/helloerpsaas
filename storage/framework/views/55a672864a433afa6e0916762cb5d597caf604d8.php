    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo app('translator')->getFromJson('superadmin::lang.allow_email_settings_to_businesses'); ?> 
                </label>
                <?php
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo app('translator')->getFromJson('superadmin::lang.enable_new_business_registration_notification'); ?> 
                </label> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <?php echo app('translator')->getFromJson('superadmin::lang.enable_new_subscription_notification'); ?> 
                </label> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
        ...
        <div class="col-xs-12">
            <h4><?php echo app('translator')->getFromJson('superadmin::lang.welcome_email_template'); ?>:</h4>
            <strong><?php echo app('translator')->getFromJson('lang_v1.available_tags'); ?>:</strong> {business_name}, {owner_name} <br><br>
        </div>
        <div class="col-xs-12">
            <div class="form-group">
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Superadmin/Providers/../Resources/views/superadmin_settings/partials/email_smtp_settings.blade.php ENDPATH**/ ?>