        ...
        <div class="row">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-btn">
                    <button type="button" <?php if(!auth()->user()->can('unit.create')): ?> disabled <?php endif; ?> class="btn btn-default bg-white btn-flat quick_add_unit btn-modal" data-href="<?php echo e(action('UnitController@create', ['quick_add' => true]), false); ?>" title="<?php echo app('translator')->getFromJson('unit.add_unit'); ?>" data-container=".view_modal"><i class="fa fa-plus-circle text-primary fa-lg"></i></button>
                  </span>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-4" id="alert_quantity_div" <?php if(!$product->enable_stock): ?> style="display:none" <?php endif; ?>>
              <div class="form-group">
                ...
                ?>
                <?php echo Form::text('alert_quantity', number_format($product->alert_quantity, config('constants.quantity_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control input_number',
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <small>
                    <p class="help-block">
                        <?php echo app('translator')->getFromJson('lang_v1.previous_file_will_be_replaced'); ?><br>
    ...
    <?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
        ...
        <?php if(session('business.enable_product_expiry')): ?>
            ...
            <div class="form-group">
              <div class="multi-input">
                ...
                ?>
                  ...
                  <?php echo Form::text('expiry_period', number_format($product->expiry_period, config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), ['class' => 'form-control pull-left input_number',
          ...
          <div class="col-sm-4">
            <div class="checkbox">
              <label>
                <?php echo Form::checkbox('enable_sr_no', 1, $product->enable_sr_no, ['class' => 'input-icheck']);; ?> <strong><?php echo app('translator')->getFromJson('lang_v1.enable_imei_or_sr_no'); ?></strong>
              </label>
              <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
          ...
          <div class="form-group">
            <br>
            <label>
              <?php echo Form::checkbox('not_for_selling', 1, $product->not_for_selling, ['class' => 'input-icheck']);; ?> <strong><?php echo app('translator')->getFromJson('lang_v1.not_for_selling'); ?></strong>
            </label> <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
                    data-container="body" data-toggle="popover" data-placement="auto bottom" 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/product/edit.blade.php ENDPATH**/ ?>