<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <?php echo Form::open(['url' => action('Restaurant\ModifierSetsController@update', [$modifer_set->id]), 'method' => 'PUT', 'id' => 'edit_form' ]); ?>


    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
      <h4 class="modal-title"><?php echo app('translator')->getFromJson( 'restaurant.edit_modifier' ); ?></h4>
    </div>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="modifier_name_edit[<?php echo e($modifier->id, false); ?>]" 
                        class="form-control" value="<?php echo e($modifier->name, false); ?>" placeholder="<?php echo app('translator')->getFromJson( 'lang_v1.name' ); ?>" required>
                    </div>
                  </td>
                  <td>
                    <div class="form-group">
                      <input type="text" name="modifier_price_edit[<?php echo e($modifier->id, false); ?>]" 
                      class="form-control input_number" value="<?php echo e(number_format($modifier->sell_price_inc_tax, config('constants.currency_precision', 2), session('currency')['decimal_separator'], session('currency')['thousand_separator']), false); ?>" placeholder="<?php echo app('translator')->getFromJson( 'lang_v1.price' ); ?>" required>
                    </div>
                  </td>
                  <td>
                    <?php if(!$loop->first): ?>
...
</div><!-- /.modal-dialog --><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/restaurant/modifier_sets/edit.blade.php ENDPATH**/ ?>