    ...
    <div class="row">
        ...
        <?php $__env->startComponent('components.widget', ['class' => 'box-primary']); ?>
            <table class="table" id="expense_report_table">
                <thead>
                    <tr>
                        <th><?php echo app('translator')->getFromJson( 'expense.expense_categories' ); ?></th>
                        <th><?php echo app('translator')->getFromJson( 'report.total_expense' ); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                ...
                <tfoot>
                    <tr>
                        <td><?php echo app('translator')->getFromJson('sale.total'); ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/report/expense_report.blade.php ENDPATH**/ ?>