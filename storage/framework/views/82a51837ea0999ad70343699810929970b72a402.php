...
<?php if(!empty($status) && $status != $old_status): ?>
    <tr>
        <th class="width-50"><?php echo app('translator')->getFromJson('sale.status'); ?>: </th> 
...
<?php if(!empty($shipping_status) && $shipping_status != $old_shipping_status): ?>
    <tr>
        <th class="width-50"><?php echo app('translator')->getFromJson('lang_v1.shipping_status'); ?>: </th> 
        <td class="width-50 text-left">
...
<?php if(!empty($final_total) && $final_total != $old_final_total): ?>
    <tr>
    <th class="width-50"><?php echo app('translator')->getFromJson('sale.total'); ?>: </th> 
    <td class="width-50 text-left">
...
<?php if(!empty($payment_status) && $payment_status != $old_payment_status): ?>
    <tr>
        <th class="width-50"><?php echo app('translator')->getFromJson('sale.payment_status'); ?>: </th> 
        <td class="width-50 text-left">
            <?php if(!empty($old_payment_status)): ?>
                <span class="label bg-info"><?php echo app('translator')->getFromJson('lang_v1.' . $old_payment_status); ?></span> --> 
            <?php endif; ?>
                <span class="label bg-info"><?php echo app('translator')->getFromJson('lang_v1.' . $payment_status); ?></span>
        </td>
    </tr>
<?php endif; ?>
...
<?php endif; ?>
</table><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/sale_pos/partials/activity_row.blade.php ENDPATH**/ ?>