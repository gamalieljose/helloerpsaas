    ...
    <div class="row">
        ...
        <div class="col-xs-4">
            <div class="checkbox">
                <label>
                    <br/>
                    <?php echo Form::checkbox('enable_auto_sync', 1, !empty($default_settings['enable_auto_sync']), ['class' => 'input-icheck'] );; ?> <?php echo app('translator')->getFromJson('woocommerce::lang.enable_auto_sync'); ?>
                </label>
                <?php
                if(session('business.enable_tooltip')){
                    echo '<i class="fa fa-info-circle text-info hover-q no-print " aria-hidden="true" 
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Woocommerce/Providers/../Resources/views/woocommerce/partials/api_settings.blade.php ENDPATH**/ ?>