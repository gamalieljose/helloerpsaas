	...
	<div class="form-group">
		<div class="input-group">
			...
			<div class="input-group-btn">
                <button type="button" class="btn btn-default bg-white btn-flat" id="select_all_service_staff" data-toggle="tooltip" title="<?php echo app('translator')->getFromJson('lang_v1.select_same_for_all_rows'); ?>"><i class="fa fa-check"></i></button>
            </div>
            <?php endif; ?>
		</div>
	</div>
</div>
<?php endif; ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/restaurant/partials/pos_table_dropdown.blade.php ENDPATH**/ ?>