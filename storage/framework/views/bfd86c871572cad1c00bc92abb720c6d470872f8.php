<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title"><?php echo app('translator')->getFromJson( 'unit.add_unit' ); ?></h4>
    </div>
        ...
        <?php if(!$quick_add): ?>
          <div class="form-group col-sm-12">
            <div class="form-group">
                <div class="checkbox">
                  <label>
                     <?php echo Form::checkbox('define_base_unit', 1, false,[ 'class' => 'toggler', 'data-toggle_id' => 'base_unit_div' ]);; ?> <?php echo app('translator')->getFromJson( 'lang_v1.add_as_multiple_of_base_unit' ); ?>
                  </label> <?php
          ...
          <div class="form-group col-sm-12 hide" id="base_unit_div">
            <table class="table">
              <tr>
                <th style="vertical-align: middle;">1 <span id="unit_name"><?php echo app('translator')->getFromJson('product.unit'); ?></span></th>
...
</div><!-- /.modal-dialog --><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/unit/create.blade.php ENDPATH**/ ?>