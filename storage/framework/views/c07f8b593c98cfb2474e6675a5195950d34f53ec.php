	...
	<div class="box-body">
		<div class="row">
			<div class="col-md-4 col-sm-6">
				<br>
				<label>
	              <?php echo Form::checkbox('is_recurring', 1, !empty($expense->is_recurring) == 1, ['class' => 'input-icheck', 'id' => 'is_recurring']);; ?> <?php echo app('translator')->getFromJson('lang_v1.is_recurring'); ?>?
	            </label><?php
		    ...
		    <div class="col-md-4 col-sm-6">
		        <div class="form-group">
			        ...
			        <p class="help-block"><?php echo app('translator')->getFromJson('lang_v1.recur_expense_repetition_help'); ?></p>
		        </div>
		    </div>
		    <?php
		    	$repetitions = [];
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/expense/recur_expense_form_part.blade.php ENDPATH**/ ?>