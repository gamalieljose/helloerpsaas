      		...
      		<div class="row">
      			<div class="col-sm-9">
	      			<div class="col-sm-4 invoice-col">
						...
						<?php endif; ?>
						<br>
						<strong><?php echo app('translator')->getFromJson('lang_v1.available_in_locations'); ?>:</strong>
						...
						<?php if(!empty($product->media->first())): ?> <br>
							<strong><?php echo app('translator')->getFromJson('lang_v1.product_brochure'); ?>:</strong>
...
<?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/product/view-modal.blade.php ENDPATH**/ ?>