                    ...
                    <table class="table table-bordered table-striped" id="payment_account_report">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo app('translator')->getFromJson('account.payment_ref_no'); ?></th>
                                <th><?php echo app('translator')->getFromJson('account.invoice_ref_no'); ?></th>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            payment_account_report = $('#payment_account_report').DataTable({
                            ...
                            serverSide: true,
                            "ajax": {
                                "url": "<?php echo e(action('AccountReportsController@paymentAccountReport'), false); ?>",
                                "data": function ( d ) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/account_reports/payment_account_report.blade.php ENDPATH**/ ?>