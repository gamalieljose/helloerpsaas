...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson( 'account.balance_sheet'); ?>
    </h1>
</section>
...
<section class="content">
    <div class="row no-print">
        <div class="col-sm-12">
            ...
            <div class="col-sm-3 col-xs-6">
                    <label for="end_date"><?php echo app('translator')->getFromJson('messages.filter_by_date'); ?>:</label>
    ...
    <div class="box box-solid">
        <div class="box-header print_section">
            <h3 class="box-title"><?php echo e(session()->get('business.name'), false); ?> - <?php echo app('translator')->getFromJson( 'account.balance_sheet'); ?> - <span id="hidden_date"><?php echo e(\Carbon::createFromTimestamp(strtotime('now'))->format(session('business.date_format')), false); ?></span></h3>
        </div>
        <div class="box-body">
            <table class="table table-border-center no-border table-pl-12">
                <thead>
                    <tr class="bg-gray">
                        <th><?php echo app('translator')->getFromJson( 'account.liability'); ?></th>
                        <th><?php echo app('translator')->getFromJson( 'account.assets'); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td>
                            <table class="table">
                                <tr>
                                    <th><?php echo app('translator')->getFromJson('account.supplier_due'); ?>:</th>
                                <td>
                        ...
                        <td>
                            <table class="table" id="assets_table">
                                <tbody>
                                    <tr>
                                        <th><?php echo app('translator')->getFromJson('account.customer_due'); ?>:</th>
                                        <td>
                                    ...
                                    <tr>
                                        <th><?php echo app('translator')->getFromJson('report.closing_stock'); ?>:</th>
                                        <td>
                                    ...
                                    <tr>
                                        <th colspan="2"><?php echo app('translator')->getFromJson('account.account_balances'); ?>:</th>
                                    </tr>
                                </tbody>
                    ...
                    <tr class="bg-gray">
                        <td>
                            <table class="table bg-gray mb-0 no-border">
                                <tr>
                                    <th>
                                        <?php echo app('translator')->getFromJson('account.total_liability'); ?>: 
                                    </th>
                                    <td>
                        ...
                        <td>
                            <table class="table bg-gray mb-0 no-border">
                                <tr>
                                    <th>
                                        <?php echo app('translator')->getFromJson('account.total_assets'); ?>: 
                                    </th>
                                    <td>
...
<script type="text/javascript">
    ...
    function update_balance_sheet(){
        ...
        $.ajax({
            url: "<?php echo e(action('AccountReportsController@balanceSheet'), false); ?>?end_date=" + end_date + '&location_id=' + location_id, 
            dataType: "json",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/account_reports/balance_sheet.blade.php ENDPATH**/ ?>