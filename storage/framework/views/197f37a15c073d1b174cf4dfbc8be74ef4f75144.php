...
<input type="hidden" id="item_addition_method" value="<?php echo e($business_details->item_addition_method, false); ?>">
				...
				<?php endif; ?>
					...
					<div class="col-sm-3">
						<div class="form-group">
							...
							<p class="help-block"><?php echo app('translator')->getFromJson('lang_v1.keep_blank_to_autogenerate'); ?></p>
						</div>
					</div>
					<?php endif; ?>
	...
	<div class="row">
		...
		<div class="col-sm-12 text-center">
			<button type="button" id="submit-sell" class="btn btn-primary btn-big"><?php echo app('translator')->getFromJson('messages.save'); ?></button>
			<button type="button" id="save-and-print" class="btn btn-success btn-big"><?php echo app('translator')->getFromJson('lang_v1.save_and_print'); ?></button>
		</div>
	</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/sell/create.blade.php ENDPATH**/ ?>