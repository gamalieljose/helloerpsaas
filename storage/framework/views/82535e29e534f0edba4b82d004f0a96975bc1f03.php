<!-- START_<?php echo e($route['id'], false); ?> -->
<?php if($route['metadata']['title'] != ''): ?>## <?php echo e($route['metadata']['title'], false); ?>

<?php else: ?>## <?php echo e($route['uri'], false); ?><?php endif; ?>
...
> Example response (<?php echo e($response['status'], false); ?>):
...
`<?php echo e($method, false); ?> <?php echo e($route['uri'], false); ?>`
...
<?php $__currentLoopData = $route['urlParameters']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute => $parameter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    `<?php echo e($attribute, false); ?>` | <?php if($parameter['required']): ?> required <?php else: ?> optional <?php endif; ?> | <?php echo $parameter['description']; ?>
...
<?php $__currentLoopData = $route['bodyParameters']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attribute => $parameter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    `<?php echo e($attribute, false); ?>` | <?php echo e($parameter['type'], false); ?> | <?php if($parameter['required']): ?> required <?php else: ?> optional <?php endif; ?> | <?php echo $parameter['description']; ?>

    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php endif; ?>

<!-- END_<?php echo e($route['id'], false); ?> -->
<?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/vendor/mpociot/laravel-apidoc-generator/src/../resources/views//partials/route.blade.php ENDPATH**/ ?>