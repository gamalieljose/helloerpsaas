...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson( 'messages.business_location_settings' ); ?> - <?php echo e($location->name, false); ?></h1>
    <!-- <ol class="breadcrumb">
        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true"><?php echo app('translator')->getFromJson('receipt.receipt_settings'); ?></a></li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane active" id="tab_1">
                    <div class="row">
                        <div class="col-md-12">
                            <h4><?php echo app('translator')->getFromJson( 'receipt.receipt_settings'); ?>
                                <small><?php echo app('translator')->getFromJson( 'receipt.receipt_settings_mgs'); ?></small>
                            </h4>
                        </div>
                    </div>
                    <br>
                ...
                ?>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <button class="btn btn-primary pull-right" type="submit"><?php echo app('translator')->getFromJson('messages.update'); ?></button>
                            </div>
                        </div>
                        <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/location_settings/index.blade.php ENDPATH**/ ?>