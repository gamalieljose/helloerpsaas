...
<?php if(!empty($view_data['parts'])): ?>
	<input type="hidden" id="pos_repair_parts_used" value="<?php echo e(json_encode($view_data['parts']), false); ?>">
<?php endif; ?>

<?php if(!empty($view_data['job_sheet']['location_id'])): ?>
<input type="hidden" id="job_sheet_location_id" value="<?php echo e($view_data['job_sheet']['location_id'], false); ?>">
<?php endif; ?>
...
<div class="row">
	...
	<div class="col-sm-6 mt-15">
		<div class="btn-group mt-5" role="group">
			<button type="button" class="btn btn-primary btn-flat" data-toggle="modal" data-target="#checklist_modal"><i class="fa fa-plus"></i> <?php echo app('translator')->getFromJson('repair::lang.pre_repair_checklist'); ?></button>
			<button type="button" class="btn btn-primary btn-flat" data-toggle="modal" data-target="#security_modal"><i class="fa fa-lock"></i> <?php echo app('translator')->getFromJson('repair::lang.security'); ?></button>
		</div>
	</div>
</div>
<div class="row">
...
</style><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Repair/Providers/../Resources/views/repair/partials/repair_pos.blade.php ENDPATH**/ ?>