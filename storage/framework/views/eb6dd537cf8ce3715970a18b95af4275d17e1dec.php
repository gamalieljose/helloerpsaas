    ...
    <div class="row">
    	<div class="col-sm-12">
    		<ul>
    			...
    			<li><?php echo __('woocommerce::lang.api_settings_help_text'); ?>. <a href="https://docs.woocommerce.com/document/woocommerce-rest-api/#section-3" target="_blank"><?php echo app('translator')->getFromJson('lang_v1.click_here'); ?></a> <?php echo app('translator')->getFromJson('lang_v1.for_more_info'); ?></li>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Woocommerce/Providers/../Resources/views/woocommerce/partials/api_instructions.blade.php ENDPATH**/ ?>