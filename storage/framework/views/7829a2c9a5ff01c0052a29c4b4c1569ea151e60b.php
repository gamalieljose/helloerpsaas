<?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		...
		<div class="box box-success hvr-grow-shadow">
			...
			<div class="box-body text-center">
				...
				?>
					...
					<?php else: ?>
						<?php echo app('translator')->getFromJson('superadmin::lang.free_for_duration', ['duration' => $package->interval_count . ' ' . $interval_type]); ?>
					<?php endif; ?>
				</h3>
			</div>
			<!-- /.box-body -->
				...
				<?php else: ?>
					<?php if(isset($action_type) && $action_type == 'register'): ?>
						...
						class="btn btn-block btn-success">
		    				<?php if($package->price != 0): ?>
		    					<?php echo app('translator')->getFromJson('superadmin::lang.register_subscribe'); ?>
		    				<?php else: ?>
		    					<?php echo app('translator')->getFromJson('superadmin::lang.register_free'); ?>
		    				<?php endif; ?>
	    				</a>
					<?php else: ?>
						...
						class="btn btn-block btn-success">
		    				<?php if($package->price != 0): ?>
		    					<?php echo app('translator')->getFromJson('superadmin::lang.pay_and_subscribe'); ?>
		    				<?php else: ?>
		    					<?php echo app('translator')->getFromJson('superadmin::lang.subscribe'); ?>
		    				<?php endif; ?>
	    				</a>
					<?php endif; ?>
				<?php endif; ?>
    ...
    <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Superadmin/Providers/../Resources/views/subscription/partials/packages.blade.php ENDPATH**/ ?>