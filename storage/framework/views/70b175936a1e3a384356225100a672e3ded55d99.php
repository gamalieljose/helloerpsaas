<div class="col-md-4 col-sm-6 col-xs-12 col-custom">
    <div class="box box-solid">
        <div class="box-header with-border">
            ...
            <h3 class="box-title"><?php echo app('translator')->getFromJson('essentials::lang.holidays'); ?></h3>
        </div>
        <div class="box-body p-10">
            <table class="table no-margin">
                <tbody>
                    <tr>
                        <th class="bg-light-gray" colspan="3"><?php echo app('translator')->getFromJson('home.today'); ?></th>
                    </tr>
                    ...
                    <tr>
                        <th class="bg-light-gray" colspan="3"><?php echo app('translator')->getFromJson('lang_v1.upcoming'); ?></th>
                    </tr>
...
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Essentials/Providers/../Resources/views/dashboard/holidays.blade.php ENDPATH**/ ?>