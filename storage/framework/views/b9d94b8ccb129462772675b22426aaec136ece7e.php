...
<section class="content-header">
    <h1><?php echo app('translator')->getFromJson( 'restaurant.tables' ); ?>
        <small><?php echo app('translator')->getFromJson( 'restaurant.manage_your_tables' ); ?></small>
    </h1>
    <!-- <ol class="breadcrumb">
...
<section class="content">
	...
	<div class="box">
        <div class="box-header">
        	<h3 class="box-title"><?php echo app('translator')->getFromJson( 'restaurant.all_your_tables' ); ?></h3>
            	...
            	<table class="table table-bordered table-striped" id="tables_table">
            		<thead>
            			<tr>
            				...
            				<th><?php echo app('translator')->getFromJson( 'restaurant.description' ); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/restaurant/table/index.blade.php ENDPATH**/ ?>