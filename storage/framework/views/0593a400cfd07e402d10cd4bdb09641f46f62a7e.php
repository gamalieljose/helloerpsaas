    ...
    <div class="modal-content edit-subscription-modal">
     <?php echo Form::open(['url' => action('\Modules\Superadmin\Http\Controllers\SuperadminSubscriptionsController@updateSubscription'), 'method' => 'POST', 'id' => 'edit_subscription_form']); ?>
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><?php echo app('translator')->getFromJson( "superadmin::lang.edit_subscription"); ?></h4>
      </div>
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary"><?php echo app('translator')->getFromJson( "superadmin::lang.update"); ?></button>
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo app('translator')->getFromJson( "superadmin::lang.close"); ?></button>
      </div>
      <?php echo Form::close(); ?>

    </div>
</div>
<?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Superadmin/Providers/../Resources/views/superadmin_subscription/edit_date_modal.blade.php ENDPATH**/ ?>