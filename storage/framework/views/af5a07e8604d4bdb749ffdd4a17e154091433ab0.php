<div class="pos-tab-content">
    <div class="row">
        ...
        <div class="col-xs-12 test_email_btn <?php if(!empty($email_settings['use_superadmin_settings'])): ?> hide <?php endif; ?>">
            <button type="button" class="btn btn-success pull-right" id="test_email_btn"><?php echo app('translator')->getFromJson('lang_v1.test_email_configuration'); ?></button>
        </div>
    </div>
</div><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/business/partials/settings_email.blade.php ENDPATH**/ ?>