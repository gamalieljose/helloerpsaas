<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title"><?php echo app('translator')->getFromJson( 'expense.add_expense' ); ?></h4>
        </div>
        <div class="modal-body">
            ...
            <div class="payment_row">
                <h4><?php echo app('translator')->getFromJson('purchase.add_payment'); ?>:</h4>
...
<?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/resources/views/expense/add_expense_modal.blade.php ENDPATH**/ ?>