...
<div class="login-form col-md-12 col-xs-12 right-col-content">
    ...
    <form method="POST" action="<?php echo e(action('\Modules\Repair\Http\Controllers\CustomerRepairStatusController@postRepairStatus'), false); ?>" id="check_repair_status">
        ...
        <div class="form-group">
    		<div class="input-group">
            	...
            	<input type="text" name="serial_no" class="form-control" id="repair_serial_no" placeholder="<?php echo app('translator')->getFromJson('repair::lang.serial_no'); ?>">
    		</div>
        </div>
        <div class="form-group">
	        <button type="submit" class="btn-login btn btn-primary btn-flat ladda-button">
	        	<?php echo app('translator')->getFromJson('lang_v1.search'); ?>
	       	</button>
	    </div>
   </form>
</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('repair::layouts.repair_status', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Repair/Providers/../Resources/views/customer_repair/index.blade.php ENDPATH**/ ?>