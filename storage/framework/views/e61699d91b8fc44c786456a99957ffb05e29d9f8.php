			...
			<div class="timeline-item">
				...
				<h3 class="timeline-header timeline-body-custom-color">
					<?php if(($activity->subject_type == 'Modules\Project\Entities\Project') && $activity->description == 'settings_updated'): ?>
						...
						<?php echo app('translator')->getFromJson('project::lang.project_settings_updated', [
							'name' => $activity->causer->user_full_name
						]); ?>
					<?php elseif($activity->subject_type == 'Modules\Project\Entities\Project'): ?>

						<?php echo app('translator')->getFromJson('project::lang.project_activity', [
							'name' => $activity->causer->user_full_name ,
							'description' => $activity->description
						]); ?>
					<?php elseif($activity->subject_type == 'Modules\Project\Entities\ProjectTask'): ?>

						<?php echo app('translator')->getFromJson('project::lang.project_task_activity', [
							'name' => $activity->causer->user_full_name ,
							'description' => $activity->description
						]); ?>
					<?php elseif($activity->subject_type == 'App\DocumentAndNote'): ?>
						
						<?php echo app('translator')->getFromJson('project::lang.project_note_activity', [
							'name' => $activity->causer->user_full_name ,
							'description' => $activity->description
						]); ?>
					...
					<?php elseif($activity->subject_type == 'Modules\Project\Entities\ProjectTimeLog'): ?>
						...
						<?php echo app('translator')->getFromJson('project::lang.project_timelog_activity', [
							'name' => $activity->causer->user_full_name ,
							'description' => $activity->description
						]); ?>
				...
				<div class="timeline-body timeline-body-custom-color">
					...
					<?php elseif($activity->subject_type == 'Modules\Project\Entities\ProjectTask'): ?>
						...
						<?php if($activity->description == 'created'): ?>
							<a data-href='<?php echo e(action("\Modules\Project\Http\Controllers\TaskController@show", ["id" => $activity->subject->id, "project_id" => $activity->subject->project_id]), false); ?>' class="cursor-pointer view_a_project_task text-black">
					...
					<?php elseif($activity->subject_type == 'Modules\Project\Entities\ProjectTimeLog'): ?>
						...
						<?php if($activity->description == 'created'): ?>
							<b><?php echo app('translator')->getFromJson('project::lang.work_hour'); ?>:</b>
							<span>
...
<?php endif; ?><?php /**PATH /home/u997099361/domains/nacionalcode.org/public_html/possaas/Modules/Project/Providers/../Resources/views/activity/show.blade.php ENDPATH**/ ?>