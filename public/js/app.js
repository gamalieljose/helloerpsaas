...
$(document).on('submit', 'form#customer_add_form', function(e) {
    e.preventDefault();
    var data = $(this).serialize();
...
$(document).on('click', 'button.edit_customer_button', function() {
    $('div.customer_modal').load($(this).data('href'), function() {
        $(this).modal('show');

        $('form#customer_edit_form').submit(function(e) {
            e.preventDefault();
            var data = $(this).serialize();
...
$(document).on('click', 'button.delete_customer_button', function() {
    swal({
        title: LANG.sure,
        text: LANG.confirm_delete_customer,
        icon: 'warning',
        buttons: true,
        dangerMode: true,
    }).then(willDelete => {
...
$(document).on('submit', 'form#bankaccount_add_form', function(e) {
    e.preventDefault();
    var data = $(this).serialize();
    ...
    $.ajax({
        ...
        success: function(result) {
            if (result.success == true) {
                $('div.bankaccount_modal').modal('hide');
                toastr.success(result.msg);
                bankaccount_table.ajax.reload();
            } else {
                toastr.error(result.msg);
            }
        },
...
//Bankaccount table
var bankaccount_table = $('#bankaccount_table').DataTable({
    processing: true,
    serverSide: true,
    ajax: '/bank-account',
...
$(document).on('click', 'button.edit_bankaccount_button', function() {
    $('div.bankaccount_modal').load($(this).data('href'), function() {
        $(this).modal('show');

        $('form#bankaccount_edit_form').submit(function(e) {
            e.preventDefault();
            var data = $(this).serialize();
...
$(document).on('click', 'button.delete_bankaccount_button', function() {
    swal({
        title: LANG.sure,
        text: LANG.confirm_delete_customer,
        icon: 'warning',
